...
$(document).ready(function() {
	...
	$("header").append("<div class='app-menu-mask'></div><a class=\"mui-icon mui-icon-bars mui-pull-right \"></a> <div class=\"app-menu\"> <ul class=\"app-menu-items\"><li class=\"app-menu-item\">回到主页</li> <li class=\"app-menu-item\" href=\"#popover\">打开菜单</li> <li class=\"app-menu-item\">注销登录</li> <li class=\"app-menu-item\">退出应用</li><li class=\"app-menu-item\">检查更新</li> </ul> </div>");
