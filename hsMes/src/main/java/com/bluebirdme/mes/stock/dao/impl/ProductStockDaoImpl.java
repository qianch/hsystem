...
public class ProductStockDaoImpl extends BaseDaoImpl implements IProductStockDao {
    ...
    public Map<String, Object> stockView(Filter filter, Page page) {
        return this.findPageInfo(filter, page, "productStock-view");
    }

    @Override
    public Map<String, Object> stockViewNew(Filter filter, Page page) {
        return this.findPageInfo(filter, page, "productStock-view-new");
    }

    @Override
    public Map<String, Object> stockViewNewPcj(Filter filter, Page page) {
        return this.findPageInfo(filter, page, "productStock-view-new-PCJ");
    }


    public List<Map<String, Object>> findProductStockInfo(String warehouseCode, String warehousePosCode) {
    ...
    public List<Map<String, Object>> findWarhourse(String salesOrderCode, String batchCode, String productModel) {
