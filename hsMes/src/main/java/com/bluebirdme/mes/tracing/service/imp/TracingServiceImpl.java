...
public class TracingServiceImpl extends BaseServiceImpl implements ITracingService {
    @Resource
    ...
    // 通过托条码查询TrayBarCode
    public HashMap<String, List<TrayBarCode>> findTrayBarCode(List<String> trayCodeList) {
        HashMap<String, List<TrayBarCode>> resultList = new HashMap<>();
    ...
    // 通过托条码查询产品出库记录
    public HashMap<String, List<ProductOutRecord>> findOutStockRecordByCondition(List<String> barcode, int type) {
        HashMap<String, List<ProductOutRecord>> resultList = new HashMap<>();
        if (type == TracingType.TRAYBARCODE) {
            for (String trayCode : barcode) {
                HashMap<String, Object> map = new HashMap<>();
                map.put("trayCode", trayCode);
                resultList.put(trayCode, findListByMap(ProductOutRecord.class, map));
            }
    ...
    public HashMap<String, List<ProductInRecord>> findProductInRecord(List<String> barcode, int type) {
        HashMap<String, List<ProductInRecord>> resultList = new HashMap<>();
        if (type == TracingType.TRAYBARCODE) {
            for (String trayCode : barcode) {
                HashMap<String, Object> map = new HashMap<>();
                map.put("trayCode", trayCode);
                resultList.put(trayCode, findListByMap(ProductInRecord.class, map));
            }
        } else if (type == TracingType.ROLLBARCODE) {
            for (String trayCode : barcode) {
                HashMap<String, Object> map = new HashMap<>();
    ...
    // 通过托条码查询箱托卷关系
    public HashMap<String, List<TrayBoxRoll>> findTrayBoxRollByCondition(List<String> barcode, int type) {
        HashMap<String, List<TrayBoxRoll>> resultList = new HashMap<>();
        if (type == TracingType.TRAYBARCODE) {
            for (String trayCode : barcode) {
                HashMap<String, Object> map = new HashMap<>();
    ...
    public HashMap<String, List<SalesOrder>> findSalesOrder(
        ...
        HashMap<String, List<SalesOrder>> resultList = new HashMap<>();
    ...
    public HashMap<Long, List<SalesOrderDetail>> findSalesOrderDetail(List<Long> ids, int type) {
        HashMap<Long, List<SalesOrderDetail>> resultList = new HashMap<>();
    ...
    public HashMap<String, List<ProducePlan>> findProducePlan(List<String> salesOrderCodeList) {
        HashMap<String, List<ProducePlan>> resultList = new HashMap<>();
    ...
    public HashMap<Long, List<ProducePlanDetail>> findProducePlanDetail(List<Long> producePlanId) {
        HashMap<Long, List<ProducePlanDetail>> resultList = new HashMap<>();
    ...
    public HashMap<String, List<RollBarcode>> findRollBarcodes(List<String> batchCodes) {
        HashMap<String, List<RollBarcode>> resultList = new HashMap<>();
    ...
    public HashMap<String, List<ProducePlanDetail>> findProducePlanDetailByBatchCode(List<String> batchCodes) {
        HashMap<String, List<ProducePlanDetail>> resultList = new HashMap<>();
        for (String batchCode : batchCodes) {
            HashMap<String, Object> map = new HashMap<>();
            map.put("batchCode", batchCode);
            resultList.put(batchCode, findListByMap(ProducePlanDetail.class, map));
        }
        return resultList;
    }
    ...
    public HashMap<String, List<WeavePlan>> findWeavePlanByBatchCode(List<String> batchCodes) {
        HashMap<String, List<WeavePlan>> resultList = new HashMap<>();
        for (String batchCode : batchCodes) {
            HashMap<String, Object> map = new HashMap<>();
            map.put("batchCode", batchCode);
    ...
    public HashMap<String, List<CutPlan>> findCutPlanByBatchCode(List<String> batchCodes) {
        HashMap<String, List<CutPlan>> resultList = new HashMap<>();
        for (String batchCode : batchCodes) {
            HashMap<String, Object> map = new HashMap<>();
            map.put("batchCode", batchCode);
