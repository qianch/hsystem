...
public class TrayBarCodeController extends BaseController {
    ...
    public String salesOrderByRollCode(String code) {
    ...
    public String salesOrderByBoxCode(String code) {
    ...
    public String salesOrderByTrayCode(String code) {
    ...
    public String productByRollCode(String code) {
    ...
    public String productByBoxCode(String code) {
    ...
    public String FindPrints(Long id) {
        ...
        Gson gson = new Gson();
        List<BarCodePrintRecord> list = gson.fromJson(trayBarcode.getIndividualOutPutString(), new TypeToken<List<BarCodePrintRecord>>() {
        }.getType());
