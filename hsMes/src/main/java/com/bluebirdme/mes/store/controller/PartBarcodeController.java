...
public class PartBarcodeController extends BaseController {
    ...
    @Resource
    IPartBarcodeService partBarcodeService;
    ...
    public String FindPrints(Long id) {
        ...
        Gson gson = new Gson();
        List<BarCodePrintRecord> list = gson.fromJson(partBarcode.getIndividualOutPutString(), new TypeToken<List<BarCodePrintRecord>>() {
        }.getType());
