...
public class RollBarcodeController extends BaseController {
    ...
    @Resource
    IRollBarcodeService rollBarcodeService;
    ...
    @Valid
    public String editBarCode(RollBarcode rollBarcode) {
        rollBarcodeService.update(rollBarcode);
        return GsonTools.toJson(rollBarcode);
    }
    ...
    public String FindPrints(Long id) {
        ...
        Gson gson = new Gson();
        List<BarCodePrintRecord> list = gson.fromJson(rollBarcode.getIndividualOutPutString(), new TypeToken<List<BarCodePrintRecord>>() {
        }.getType());
