...
public class FtcBcBomController extends BaseController {
	...
	final String addOrEdit="baseInfo/ftcBcBomVersionAddOrEdit";
	...
	public String saveDetail(@RequestBody FtcBcBomVersionDetail detail) throws Exception {
		...
		List<FtcBcBomVersionDetail> li = ftcBcBomVersionDetailService.findListByMap(FtcBcBomVersionDetail.class, map);
		// for (BcBomVersionDetail bv : li) {
		// if (bv.getPackMaterialName().equals(detail.getPackMaterialName())) {
		// return ajaxError("已经有相同名字的明细");
		// }
		// }
