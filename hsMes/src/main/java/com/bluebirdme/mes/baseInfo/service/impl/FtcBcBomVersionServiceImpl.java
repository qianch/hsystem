...
import com.bluebirdme.mes.baseInfo.controller.BcBomVersionDetailController;
...
public class FtcBcBomVersionServiceImpl extends BaseServiceImpl implements IFtcBcBomVersionService {
	private static Logger logger = LoggerFactory.getLogger(FtcBcBomVersionServiceImpl.class);
	@Resource
	...
	public List<Map<String, Object>> getFtcBcBomJson(String id,String productType) {
		List<FtcBcBomVersion> listMap = new ArrayList<>();
		try {
