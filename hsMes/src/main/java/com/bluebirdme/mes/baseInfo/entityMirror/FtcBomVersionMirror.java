...
@Desc("非套材工艺BOM版本")
@Entity
@Table(name="HS_FTC_PROC_BOM_VERSION_MIRROR")
@DynamicInsert
public class FtcBomVersionMirror extends BaseEntity {

	@Desc("版本ID")
	@Column(nullable=false)
	private Long ftcProcBomVersionId;
	...
	public Long getFtcProcBomVersionId() {
		return ftcProcBomVersionId;
	}

	public void setFtcProcBomVersionId(Long ftcProcBomVersionId) {
		this.ftcProcBomVersionId = ftcProcBomVersionId;
	}
