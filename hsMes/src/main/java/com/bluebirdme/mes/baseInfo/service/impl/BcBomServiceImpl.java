...
import com.bluebirdme.mes.baseInfo.dao.impl.BcBomDaoImpl;
...
public class BcBomServiceImpl extends BaseServiceImpl implements IBcBomService {
	private static Logger logger = LoggerFactory.getLogger(BcBomServiceImpl.class);
	@Resource IBcBomDao bcBomDao;
	@Resource IBCBomVersionDao bcBomVersionDao;
	@Resource IBcBomVersionDetailDao bcBomVersionDetailDao;
	@Override
	...
	*/
	public List<Map<String, Object>> getBcBomJson(String data){
		...
		HashMap<Long,Consumer> consumerMap = new HashMap<Long,Consumer>();
...
//		bcBomVersionDetailDao.deleteByPid();
		...
		for(int a=0;a<id.length;a++){
			BcBom bc=findById(BcBom.class, Long.valueOf(id[a]));
