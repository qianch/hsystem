...
public class TcBomVersionPartsController extends BaseController {
	...
	@Resource ITcBomVersionPartsService tcBomVersionPartsService;
	...
	public String edit(String ids) throws Exception{
		...
		tcBomVersionPartsService.delete(TcBomVersionParts.class,__ids);
	...
	public String getTcBomVersionPartsMirror(Filter filter, Page page) throws Exception{
