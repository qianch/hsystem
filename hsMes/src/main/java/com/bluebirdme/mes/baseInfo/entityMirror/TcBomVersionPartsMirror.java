...
@Desc("版本部件")
@Entity
@Table(name="hs_tc_proc_bom_version_parts_mirror")
@DynamicInsert
public class TcBomVersionPartsMirror extends BaseEntity {

	@Desc("BOM版本部件ID")
	@Column(nullable=false)
	@Index(name="versionPartsId")
	private Long versionPartsId;
	...
	public Long getVersionPartsId() {
		return versionPartsId;
	}

	public void setVersionPartsId(Long versionPartsId) {
		this.versionPartsId = versionPartsId;
	}
