...
public class LedTask {
    private static final Logger log = LoggerFactory.getLogger(LedTask.class);
    @Resource
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    List<Map<String, String>> wps = new ArrayList<>();
                    ...
                    if (wps.size() == 0) {
                        File file = new File(path + UUID.randomUUID() + ".bmp");
                    ...
                    List<ProgramBxFile> programs = new ArrayList<>();
