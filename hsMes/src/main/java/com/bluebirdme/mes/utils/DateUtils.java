...
public class DateUtils {
     ...
     *
     * @param day    指定的时间
     * @param offsetDays 日期偏移量，正数表示延后，负数表提前
     * @return Date
     */
    ...
    public static long diff(Date date1, Date date2, Type type) throws Exception {
        ...
        switch (type) {
            ...
            default -> throw new Exception("请指定要获取的时间差的类型：年，月，天，周，时，分，秒");
        }
    }
     ...
     *
     * @param field 如年Calendar.YEAR，月Calendar.MONTH，日，周，等等，参考{@link Calendar}
     */
