...
public class SiemensBomRestController extends BaseController {
	...
	public String enableOrDisable(@RequestParam(required=true)Long partId,Integer enable,@RequestParam(required=true)Boolean isDrawingsBom){
	...
	public String saveSuit(@RequestBody Grid<Suit> grid) throws Exception {
	...
	public String drawingsList(Long partId) throws Exception {
	...
	public String saveDrawings(@RequestBody Grid<Drawings> grid) throws Exception {
	...
	public String saveFragment(@RequestBody Grid<Fragment> grid) throws Exception {
