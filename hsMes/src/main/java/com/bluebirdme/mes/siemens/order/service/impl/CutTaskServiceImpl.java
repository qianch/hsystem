...
public class CutTaskServiceImpl extends BaseServiceImpl implements ICutTaskService {
	...
	@Resource ICutTaskDao cutTaskDao;
	
	@Resource IDrawingsService drawingsService;
	...
	public void save(CutTask task, Long pcId) throws Exception {
		...
		List<CutTaskDrawings> ctdList=new ArrayList<CutTaskDrawings>();
		...
		List<CutTaskSuit> ctsList=new ArrayList<CutTaskSuit>();
