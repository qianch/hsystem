...
public class MobileSuitController extends MobileBaseController {
	...
	@Resource IFragmentBarcodeService fbcService;

	@NoLogin
	@Journal(name = "查询派工单条码信息")
	@ResponseBody
	@RequestMapping("suit/info")
	public String getSuitInfo(String ctoCode) throws IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
	...
	public String getFragmentBarcodeInfo(String fragmentBarcode) throws IOException {
	...
	public String getPartInfo(String partBarcode, String ctoCode) throws IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
