...
public class FinishedProductDaoImpl extends BaseDaoImpl implements IFinishedProductDao {
    ...
    @Override
    public int querySlBycode(String wlbh) {
    ...
    @Override
    public int querySlinfo(String wlbh) {
    ...
    @Override
    public int queryCpggInfo(String wlbh) {
    ...
    @Override
    public int queryMfnewcode(String wlbh) {
    ...
    @Override
    public int queryJznewcode(String wlbh) {
    ...
    @Override
    public int queryJcnewcode(String wlbh) {
    ...
    @Override
    public List<Map<String, Object>> queryJZCinfo(String wlbh, String jz, String jc) {
    ...
    @Override
    public int queryJzcnewcode(String wlbh) {
    ...
    @Override
    public String getzgmcbycode(String code) {
    ...
    //产品的总克重
    @Override
    public int queryProcBomDetail(String ftcBomVersionId) {
