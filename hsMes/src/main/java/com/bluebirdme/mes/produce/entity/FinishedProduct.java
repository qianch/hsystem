...
public class FinishedProduct extends BaseEntity {
    ...
    @Desc("标签打印属性")
    @Transient
    private List<FinishedProductPrintRecord> listFinishedProductPrintRecord;

    public List<FinishedProductPrintRecord> getListFinishedProductPrintRecord() {
        return listFinishedProductPrintRecord;
    }

    public void setListFinishedProductPrintRecord(List<FinishedProductPrintRecord> listFinishedProductPrintRecord) {
        this.listFinishedProductPrintRecord = listFinishedProductPrintRecord;
    }
}
