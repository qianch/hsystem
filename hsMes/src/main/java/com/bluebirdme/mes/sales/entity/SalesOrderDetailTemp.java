...
@Desc("销售明细")
@Entity
@Table(name = "HS_Sales_Order_Detail_Temp")
public class SalesOrderDetailTemp extends BaseEntityExt {
	...
	@Desc("镜像版本id")
	private Long mirrorFtcProcBomId;
	...
	public Long getMirrorFtcProcBomId() {
		return mirrorFtcProcBomId;
	}

	public void setMirrorFtcProcBomId(Long mirrorFtcProcBomId) {
		this.mirrorFtcProcBomId = mirrorFtcProcBomId;
	}
	...
	public void setTotalWeight(Double totalWeight) {
	 ...
	 public static void main(String[] args) {
		Field fs[]=SalesOrderDetailTemp.class.getDeclaredFields();
		for(Field f:fs){
