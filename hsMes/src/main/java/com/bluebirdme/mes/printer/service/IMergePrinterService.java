...
public interface IMergePrinterService extends IBaseService {
    ...
    String doIndividualPrintBarcode(String weavePlanId,
     ...
     * @return
     */
    String doReplayPrintBarcode(String id, String type, String departmentCode, String pName, String btwfileId) throws Exception;

    String rePrint(String ids, String pName, String type);

    String reIndividualPrint(String id, String pName, String type, long btwfileId, int printCount);
