...
public class ScreenDisplayController extends BaseController {
	...
	@Resource IScreenDisplayService screenDisplayService;
...
/*	@NoLogin
	@RequestMapping(value="machineViewFirstInfo",method = RequestMethod.POST)
	@ResponseBody
	public String innerFirstInfo(String ip) throws Exception {
		if(StringUtils.isBlank(ip))return GsonTools.toJson(new ArrayList<Map<String, Object>>());
		//String ip=request.getRemoteAddr();
