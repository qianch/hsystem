...
public class CutPlanDaoImpl extends BaseDaoImpl implements ICutPlanDao {
    ...
    @Override
    public List<Map<String, Object>> userListById(String id) {
    ...
    //根据生产明细ID找人员信息
    @Override
    public List<Map<String, Object>> planCodeCombobox() {
    ...
    @Override
    public List<HashMap<String, Object>> findCutPlanUserByUserID(Long userId) {
