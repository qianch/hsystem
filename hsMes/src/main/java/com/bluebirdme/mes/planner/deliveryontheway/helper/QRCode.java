package com.bluebirdme.mes.planner.deliveryontheway.helper;
...
public class QRCode {
	...
	// IOException, NotFoundException, ChecksumException, FormatException {
	// QRCode.encode("RBZ120170117000", "D:\\Target.PNG", 200, 200);
