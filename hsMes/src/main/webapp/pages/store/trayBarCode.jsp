    ...
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            ...
            <form action="#" id="trayBarCodeSearchForm" autoSearchFunction="false">
                ...
                打印数量:<input id="printCount" class="easyui-numberbox" value="3" data-options="min:1,max:10,precision:0"
                            required="true">
        ...
        <div style="border-top:1px solid #DDDDDD">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-remove" onclick="clearTray()">清空条码</a>
        </div>
    </div>
