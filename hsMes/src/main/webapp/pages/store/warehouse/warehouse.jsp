...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" url="${path}warehouse/list" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="true" fit="true" data-options="onDblClickRow:dbClickEdit">
        <thead>
        <tr>
            <th field="ID" checkbox=true></th>
            <th field="WAREHOUSECODE" width="15">仓库代码</th>
            <th field="WAREHOUSENAME" width="15">仓库名称</th>
            <th field="WARETYPE" width="15"
