...
<head>
    ...
    <%@ include file="boxBarcode.js.jsp" %>
</head>
...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="boxBarcodeSearchForm" autoSearchFunction="false">
                ...
                <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-print" onclick="doPrintBox()">打印个性化盒条码</a>
            </form>
        </div>
        <div style="border-top:1px solid #DDDDDD">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-remove" onclick="clearBox()">清空条码</a>
        </div>
    </div>
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" toolbar="#toolbar" pagination="true"
           ...
           data-options="onLoadSuccess:dgLoadSuccess,
				remoteFilter:true">
        <thead>
        <tr>
