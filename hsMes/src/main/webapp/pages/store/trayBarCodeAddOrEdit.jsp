...
<div>
    <!--托条码表单-->
    <form id="trayBarCodeForm" method="post" ajax="true"
          action="<%=basePath %>trayBarCode/${empty trayBarCode.id ?'add':'edit'}" autocomplete="off">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="salesOrderCode" name="salesOrderCode" value="${trayBarCode.salesOrderCode}"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="batchCode" name="batchCode" value="${trayBarCode.batchCode}"
                           class="easyui-textbox" readonly="true">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="printDate" name="printDate" value="${trayBarCode.printDate}"
                           class="easyui-textbox" readonly="true">
                </td>
            </tr>
        </table>
