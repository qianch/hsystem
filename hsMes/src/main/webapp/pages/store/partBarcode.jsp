    ...
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="partBarcodeSearchForm" autoSearchFunction="false">
                ...
                创建时间:<input type="text" id="start" name="filter[startTime]" class="easyui-datetimebox">
                -<input type="text" id="end" name="filter[endTime]" class="easyui-datetimebox"><br/>
                客户名称:
                ...
                打印数量:
                <input id="printCount" class="easyui-numberbox" value="1" data-options="min:1,max:10,precision:0"
                       required="true">
