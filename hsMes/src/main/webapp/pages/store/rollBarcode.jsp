...
<head>
    ...
    <%@ include file="rollBarcode.js.jsp" %>
</head>
...
<div data-options="region:'center',border:false"
    ...
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="rollBarcodeSearchForm" autoSearchFunction="false">
                选择打印机：<input id="pName" class="easyui-combobox" name="pName"
                             required="true"
                ...
                标签模版:<input id="btwfileSelect" class="easyui-combobox" required="true">
                打印数量:<input id="printCount" class="easyui-numberbox" value="1" data-options="min:1,max:10,precision:0"
                            required="true">
                <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-print" onclick="doPrintRoll()">补打卷条码</a>
        ...
        <div style="border-top:1px solid #DDDDDD">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-remove" onclick="clearRoll()">清空卷条码</a>
        </div>
