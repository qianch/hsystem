...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="warehosePosSearchForm" autoSearchFunction="false">
                ...
                仓库类型：
                <input type="text" id="wareType" name="filter[wareType]" class="easyui-combobox" required="true"
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" url="${path}warehosePos/list"
