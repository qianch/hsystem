...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" url="${path}material/list" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="false" fit="true" data-options="onDblClickRow:dbClickEdit">
        <thead frozen="true">
        <tr>
