		...
		<table width="100%">
			...
			<tr>
				...
				<td><input type="text" id="factoryProductName"
					...
					required="true" data-options="validType:['length[0,25]']"></td>
			</tr>
			<tr>
				<td class="title" >卷重:</td>
				<td>
					<input id="productIsTc2" type="hidden" value="2" name="productIsTc" checked="checked">
					<input id="productRollWeight" name="productRollWeight"  value="${finishProduct.productRollWeight }" class="easyui-numberbox" suffix="kg" precision="2">
				</td>
			 ...
			 <tr>
				...
				<td>
					...
					class="easyui-textbox" required="true" data-options="validType:['length[0,25]']"></td>
				</td>			
			</tr>
			<tr>
				...
				<td><input  id="productProcessBom"
					...
					data-options="searcher:chooseBom" required="true"></td>
				...
				<td><input type="text" id="productProcessBomVersion"
					...
					class="easyui-textbox" editable="false" required="true"></td>
			</tr>
		</table>
	</form>
</div>