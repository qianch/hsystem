...
<script>
	...
	<input type="hidden"  id="id" name="" value="${tcBomVersion.id}">
    	<table width="100%" title="版本列表">
				<tr>
					...
					<td>
						<input type="text" data-options="required:true,validType:'length[1,20]','icons':{}" readonly="true" editable=false id="tcProcBomVersionCode" name="tcProcBomVersionCode" value="${tcBomVersion.tcProcBomVersionCode}" class="easyui-textbox"  >
					</td>
				</tr>
		</table>
    </div>
    ...
    <div class="easyui-layout" data-options="fit:true">
    	<div data-options="region:'north',collapsible:false" title="部件信息" height=40%>
    		<table singleSelect="false"  id="partsT"  style="width:100%;" class="easyui-datagrid" url=""   rownumbers="false" fit="true" fitColumns="false" >
			<thead>
				<tr>
						<th field="ID" checkbox=true></th>
						<th field="TCPROCBOMVERSIONPARTSCUTCODE" sortable="true" width="250" data-options="editor:{type:'textbox',options:{required:true}}">包装代码</th>
    	...
    	<div class="easyui-tabs" fit="true">
    		<div title="部件明细">
    			<table singleSelect="false"  id="dddg"  style="width:100%;" class="easyui-datagrid" url=""   rownumbers="true" fit="true" fitColumns="false" pagination="true">
					<thead>
						<tr>
								<th field="ID" checkbox=true></th>
    		...
    		<div title="部件成品重量胚布信息">
    			<table singleSelect="false" fit="true" id="partsFinishedWeightEmbryoCloth" remoteSort="false" fitColumns="true" pagination="true" style="width:100%;" class="easyui-datagrid" url="" rownumbers="true" fitColumns="true">
						<thead>
							<tr>
								<th field="ID" checkbox=true ></th>
