...
<div>
    <!--套材Bom版本表单-->
    <form id="tcBomVersionForm" method="post" ajax="true"
          action="<%=basePath %>tcBomVersion/${empty tcBomVersion.id ?'add':'edit'}" autocomplete="off">
        ...
        <table width="100%">
            <tr>
                ...
                <!--版本号-->
                <td>
                    <input type="text" data-options="required:true,validType:'length[1,100]'" id="tcProcBomVersionCode"
                           name="tcProcBomVersionCode" value="${tcBomVersion.tcProcBomVersionCode}"
            ...
            <tr>
                ...
                <!--客户版本号-->
                <td>
                    <input type="text" data-options="validType:'length[1,100]'" id="tcConsumerVersionCode"
                           name="tcConsumerVersionCode" value="${tcBomVersion.tcConsumerVersionCode}"
                           class="easyui-textbox" style="width:100%;">
                </td>
            </tr>
