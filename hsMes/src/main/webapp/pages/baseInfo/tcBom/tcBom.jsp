...
<div region="west" split="true" title="BOM列表" style="width:260px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',split:false,border:false" class="datagrid-toolbar"
             style="height:95px;text-align: center;">
            <input id="searchInput" type="text" class="easyui-searchbox" prompt="请输入内容" searcher="searchInfo"
                   editable="true"
                   data-options="width:'90%',icons:[{iconCls:'icon-clear',handler:function(e){$(e.data.target).searchbox('clear');findTcBom();}}]">
            <input type="text" id="testPro" value="0" class="easyui-combobox" style="width: 90%" panelHeight="auto"
            ...
            <div hidden=true>
                <input type="text" id="state" value="" class="easyui-combobox" style="width: 90%" panelHeight="auto"
            ...
            <div class="datagrid-toolbar" style="text-align: center;font-size:13px;font-weight:bolder;padding:5px;">
                <a href="javascript:void(0)" style="color:#0E2D5F;" onclick="expandAll()">展开</a> &nbsp; <a
                    href="javascript:void(0)" style="color:#0E2D5F;" onclick="collapseAll()">收缩</a> &nbsp; <a
                    href="javascript:void(0)" style="color:#0E2D5F;" onclick="reload()">刷新</a>
            </div>
        </div>
...
<div data-options="region:'center',border:false">
        ...
        <div class="easyui-tabs" fit="true">
            <div title="部件明细列表">
                <table singleSelect="true" fit="true" id="partsDetails" remoteSort="false" fitColumns="true"
                       pagination="true" style="width:100%;" class="easyui-datagrid" url="" toolbar="#toolbar"
                       rownumbers="true" fitColumns="true"
                       data-options="onClickRow:onDblClickCellD,onEndEdit:onEndEditD">
                    <thead>
                    <tr>
            ...
            <div title="部件成品重量胚布信息">
                <table singleSelect="true" fit="true" id="partsFinishedWeightEmbryoCloth" remoteSort="false"
                       ...
                       toolbar="#toolbarFW" rownumbers="true" fitColumns="true"
                       data-options="onClickRow:onDblClickCellFW,onEndEdit:onEndEditFW">
                    <thead>
                    <tr>
    ...
    <div style="height:45%">
        <table singleSelect="true" fit="true" id="parts" pagination="true" title="版本部件列表" class="easyui-datagrid"
               url="" toolbar="#toolbar2" rownumbers="true" fitColumns="false"
               data-options="onDblClickRow:onDblClickCell,onEndEdit:onEndEdit,onClickRow:onClickCell,rowStyler:tcPartsRowStyler">
            <thead>
            <tr>
                <th field="ID" checkbox=true></th>
                ...
                <th field="CUSTOMERMATERIALCODE" sortable="true" width="100" data-options="editor:{type:'textbox'}">
                    客户物料号
                </th>
