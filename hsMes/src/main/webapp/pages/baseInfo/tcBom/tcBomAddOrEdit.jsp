...
<div>
    <!--非套材工艺BOM表单-->
    <form id="tc_BomForm" method="post" ajax="true" action="<%=basePath %>tcBom/${empty tcBom.id ?'add':'edit'}"
          autocomplete="off">
        ...
        <table width="100%">
            <tr>
                ...
                <!--BOM名称-->
                <td>
                    <input type="text" data-options="required:true,validType:'length[1,100]'" id="ftcProcBomName"
                           name="tcProcBomName" value="${tcBom.tcProcBomName}" class="easyui-textbox"
                           style="width:100%;">
                </td>
            </tr>
            <tr>
                ...
                <!--BOM代码-->
                <td>
                    <input type="text" id="ftcProcBomCode" data-options="required:true,validType:'length[1,100]'"
                           name="tcProcBomCode" value="${tcBom.tcProcBomCode}" class="easyui-textbox"
                           style="width:100%;">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input id="ftcProcBomConsumer" class="easyui-searchbox" value="${consumer.consumerName}"
                           editable="false" required="true" data-options="searcher:ChooseConsumer" style="width:100%;">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <%-- <input type="text" id="ftcProcBomConsumerId" name="ftcProcBomConsumerId" value="${fTc_Bom.ftcProcBomConsumerId}" class="textbox" required="true" > --%>
                    <input type="text" id="isTestPro" name="isTestPro" value="${tcBom.isTestPro}"
            ...
            <c:if test="${empty tcBom.id}">
                <tr>
                    ...
                    <!--版本号-->
                    <td>
                        <input type="text" id="tcProcBomVersionCode" name="tcProcBomVersionCode" style="width: 100%"
                ...
                <tr>
                    ...
                    <!--客户版本号-->
                    <td>
                        <input type="text" data-options="validType:'length[0,100]'" id="tcConsumerVersionCode"
                               name="tcConsumerVersionCode" class="easyui-textbox" style="width: 100%">
                    </td>
                </tr>
                <tr>
