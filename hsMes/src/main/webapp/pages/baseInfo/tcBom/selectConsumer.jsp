...
//添加客户信息
var findC=path+"bom/tc/findConsumer";
	//双击行事件
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
		<table id="dddg" singleSelect="true" title="" class="easyui-datagrid"  url="" toolbar="#toolbar1" pagination="true" rownumbers="true" fitColumns="true" fit="true">
			<thead>
				<tr>
