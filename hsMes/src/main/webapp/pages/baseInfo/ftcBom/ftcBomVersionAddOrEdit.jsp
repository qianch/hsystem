...
<div>
    ...
    <form id="ftcBomVersionForm" method="post" ajax="true"
          action="<%=basePath %>ftcBomVersion/${empty ftcBomVersion.id ?'add':'edit'}" autocomplete="off">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <!--版本号-->
                <td>
                    <input type="text" id="ftcProcBomVersionCode" name="ftcProcBomVersionCode"
                           value="${ftcBomVersion.ftcProcBomVersionCode}" class="easyui-textbox" required="true"
            ...
            <tr>
                ...
                <!--客户版本号-->
                <td>
                    <input type="text" data-options="validType:'length[1,100]'" id="ftcConsumerVersionCode"
                           name="ftcConsumerVersionCode" value="${ftcBomVersion.ftcConsumerVersionCode}"
