...
<div>
	<!--非套材工艺BOM表单-->
	<form id="fTc_BomForm" method="post" ajax="true" action="<%=basePath %>fTc_Bom/${empty fTc_Bom.id ?'add':'edit'}" autocomplete="off" >
		
		<input type="hidden" name="id" value="${fTc_Bom.id}" />
		<!--客户信息ID-->
		<input type="hidden" id="ftcProcBomConsumerId" name="ftcProcBomConsumerId" value="${fTc_Bom.ftcProcBomConsumerId}" />
		<table width="100%">
				<tr>
					<td class="title">BOM名称:</td>
					<!--BOM名称-->
					<td>
						<input type="text" id="ftcProcBomName" name="ftcProcBomName" value="${fTc_Bom.ftcProcBomName}" style="width: 100%" class="easyui-textbox" required="true" data-options="validType:['length[0,100]']">
					</td>
				</tr>
				<tr>
					...
					<!--BOM代码-->
					<td>
						<input type="text" id="ftcProcBomCode" name="ftcProcBomCode" value="${fTc_Bom.ftcProcBomCode}" style="width: 100%" class="easyui-textbox" required="true" data-options="validType:['length[0,100]']">
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<input id="ftcProcBomConsumer" class="easyui-searchbox" value="${consumer.consumerName}" style="width: 100%" editable="false" required="true" data-options="searcher:ChooseConsumer">
					</td>
				</tr>
								<tr>
					...
					<td>
						<%-- <input type="text" id="ftcProcBomConsumerId" name="ftcProcBomConsumerId" value="${fTc_Bom.ftcProcBomConsumerId}" class="textbox" required="true" > --%>
						<input type="text" id="isTestPro" name="isTestPro" value="${fTc_Bom.isTestPro}" class="easyui-combobox" style="width: 100%" panelHeight="auto" editable="false" required="true" data-options="data: [
	                        {value:'1',text:'常规产品'},
	                        {value:'-1',text:'变更试样'},
	                        {value:'2',text:'新品试样'}
                    	]" >
				...
				<c:if test="${empty fTc_Bom.id}">
					<tr>
						...
						<!--版本号-->
						<td>
							<input type="text" id="ftcProcBomVersionCode" name="ftcProcBomVersionCode" style="width: 100%" class="easyui-textbox" data-options="validType:['length[0,100]']">
						</td>
					</tr>
					<tr>
						...
						<!--客户版本号-->
						<td>
							<input type="text" data-options="validType:'length[0,100]'" id="ftcConsumerVersionCode" name="ftcConsumerVersionCode" class="easyui-textbox" style="width: 100%" >
						</td>
					</tr>
					<tr>
