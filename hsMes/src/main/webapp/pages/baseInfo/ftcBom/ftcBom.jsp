...
<body class="easyui-layout" data-options="fit:true">
	<div region="west" split="true" title="非套材BOM列表" style="width:260px;">
		<div class="easyui-layout" fit=true>
			<div data-options="region:'north',split:false,border:false"
				...
				<input type="text" id="testPro" value="1" class="easyui-combobox" style="width: 90%" panelHeight="auto" editable="false" data-options="data: [
	                        {value:'1',text:'常规产品'},
	                        {value:'-1',text:'变更试样'},
	                        {value:'2',text:'新品试样'}
				...
				<div class="datagrid-toolbar"
					...
					<a href="javascript:void(0)" style="color:#0E2D5F;"
						...
						style="color:#0E2D5F;" onclick="collapseAll()">收缩</a> &nbsp; <a
						href="javascript:void(0)" style="color:#0E2D5F;"
						onclick="reload(true)">刷新</a>
				</div>
	...
	<div id="treeMenuVersion" class="easyui-menu" style="width:140px;">
		...
		<div onclick="forceEdit()"
			data-options="iconCls:'platform-arrow_switch'">工艺变更</div>
		 <!-- <div class="menu-sep"></div>
