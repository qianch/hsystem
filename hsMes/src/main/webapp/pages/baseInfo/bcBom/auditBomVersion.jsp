...
<table title="包材bom信息">
			<tr>
				<td class="title" style="text-align: left;">总称:</td><td id="PACKBOMGENERICNAME" >${bcBom.packBomGenericName}</td>
				<td style="text-align: left;" class="title">门幅:</td><td id="PACKBOMWIDTH">${bcBom.packBomWidth}</td>
				<td style="text-align: left;" class="title">包装大类:</td><td id="PACKBOMTYPE">${bcBom.packBomType}</td>
				<td style="text-align: left;" class="title">包装标准代码:</td><td id="PACKBOMCODE">${bcBom.packBomCode}</td>
			</tr>
			<tr>
				<td style="text-align: left;" class="title">产品规格:</td><td id="PACKBOMMODEL">${bcBom.packBomModel}</td>
				<td style="text-align: left;" class="title">卷重:</td><td id="PACKBOMWEIGHT">${bcBom.packBomWeight}</td>
				<td style="text-align: left;" class="title">卷长:</td><td id="PACKBOMLENGTH">${bcBom.packBomLength}</td>
				<td style="text-align: left;" class="title">卷径:</td><td id="PACKBOMRADIUS">${bcBom.packBomRadius}</td>
			</tr>
			<tr>
				<td style="text-align: left;" class="title">适用客户:</td><td id="PACKBOMCONSUMERID">${consumer.consumerName}</td>
				<td style="text-align: left;" class="title">每箱卷数:</td><td id="PACKBOMROLLSPERBOX">${bcBom.packBomRollsPerBox}</td>
				<td style="text-align: left;" class="title">每托箱数:</td><td id="PACKBOMBOXESPERTRAY">${bcBom.packBomBoxesPerTray}</td>
				<td style="text-align: left;" class="title">每托卷数:</td><td id="PACKBOMROLLSPERTRAY">${bcBom.packBomRollsPerTray}</td>
				
			</tr>
			<tr>
				<td style="text-align: left;" class="title">包装名称:</td><td id="PACKBOMGENERICNAME">${bcBom.packBomGenericName}</td>
			</tr>
