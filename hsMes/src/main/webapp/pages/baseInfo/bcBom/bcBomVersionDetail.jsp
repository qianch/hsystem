        ...
        <div data-options="region:'north',split:false,border:false" class="datagrid-toolbar"
            ...
            <div class="datagrid-toolbar" style="text-align: center;font-size:13px;font-weight:bolder;padding:5px;">
                <a href="javascript:void(0)" style="color:#0E2D5F;" onclick="expandAll()">展开</a> &nbsp; <a
                    ...
                    href="javascript:void(0)" style="color:#0E2D5F;" onclick="reload(true)">刷新</a>
            </div>
        </div>
    ...
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="bcBomVersionDetailSearchForm" autoSearchFunction="false">
                包材名称: <input type="text" name="filter[PACKMATERIALNAME]" like="true" class="easyui-textbox"> <a
                    href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search"
                    onclick="filter()"> 搜索 </a>
            </form>
        </div>
    </div>
    <!-- ,nowrap:false -->
    <table id="dg" singleSelect="false" title="包材BOM明细列表" class="easyui-datagrid" url="" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="false" fit="true"
           data-options="onDblClickRow:onDblClickCell,onEndEdit:onEndEdit,onClickRow:onClickCell,nowrap:false">
        <thead>
        <tr>
            <th field="ID" checkbox=true></th>
            <th field="PACKMATERIALNAME" width="13%" data-options="editor:{type:'textbox',options:{required:true}}">
                包材名称
            </th>
            ...
            <th field="PACKMATERIALCOUNT" width="7%" data-options="editor:{type:'numberbox',options:{precision:0}}">
                数量
            </th>
