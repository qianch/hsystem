...
<div>
	<!--包材bom版本信息表单-->
	<form id="bCBomVersionForm" method="post" ajax="true" action="<%=basePath %>bCBomVersion/${empty bCBomVersion.id ?'add':'edit'}" autocomplete="off" >
		...
		<table width="100%">
				<tr>
					...
					<!--版本号-->
					<td>
						<input type="text" id="packVersion" name="packVersion" value="${bCBomVersion.packVersion}" class="easyui-textbox" required="true" data-options="validType:['length[1,100]']">
					</td>
				</tr>
