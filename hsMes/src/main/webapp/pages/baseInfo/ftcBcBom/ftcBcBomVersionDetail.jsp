    ...
    <div class="easyui-layout" fit=true>
        <div data-options="region:'north',split:false,border:false" class="datagrid-toolbar"
            ...
            <input id="searchInput" type="text" class="easyui-searchbox" prompt="请输入内容" searcher="searchInfo"
                   editable="true"
                   data-options="width:'90%',icons:[{iconCls:'icon-clear',handler:function(e){$(e.data.target).searchbox('clear');findFtcBcBom();}}]">
...
<div data-options="region:'center',border:false" style="position: relative;">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="ftcBcBomVersionDetailSearchForm" autoSearchFunction="false">
                材料名称: <input type="text" name="filter[PACKMATERIALNAME]" like="true" class="easyui-textbox"> <a
    ...
    <!-- ,nowrap:false -->
    <table id="dg" singleSelect="false" title="非套材包材BOM明细列表" class="easyui-datagrid" url="" toolbar="#toolbar"
