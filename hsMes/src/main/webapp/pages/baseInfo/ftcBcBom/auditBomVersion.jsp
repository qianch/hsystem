...
<div>
    ...
    <table title="非套材包材bom信息">
        <tr>
            ...
            <td id="PACKBOMGENERICNAME">${ftcBcBom.code}</td>
            <td style="text-align: left;" class="title">适用客户:</td>
            <td id="PACKBOMWIDTH">${consumer.consumerName}</td>
            <td style="text-align: left;" class="title">卷径/cm:</td>
            <td id="PACKBOMTYPE">${ftcBcBomVersion.rollDiameter}</td>
            <td style="text-align: left;" class="title">每托卷数:</td>
            <td id="PACKBOMCODE">${ftcBcBomVersion.rollsPerPallet}</td>
        </tr>
        <tr>
            <td style="text-align: left;" class="title">托长/cm:</td>
            <td id="PACKBOMMODEL">${ftcBcBomVersion.palletLength}</td>
            <td style="text-align: left;" class="title">托宽/cm:</td>
            <td id="PACKBOMWEIGHT">${ftcBcBomVersion.palletWidth}</td>
            <td style="text-align: left;" class="title">托高/cm:</td>
            <td id="PACKBOMLENGTH">${ftcBcBomVersion.palletHeight}</td>
            <td style="text-align: left;" class="title">包材重量/kg:</td>
            <td id="PACKBOMRADIUS">${ftcBcBomVersion.bcTotalWeight}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" id="PACKBOMCONSUMERID">${ftcBcBomVersion.requirement_suliaomo}</td>
            <td style="text-align: left;" class="title">摆放要求:</td>
            <td colspan="3" id="PACKBOMGENERICNAME">${ftcBcBomVersion.requirement_baifang}</td>
        </tr>
        <tr>
            <td style="text-align: left;" class="title">打包带要求:</td>
            <td colspan="3" id="PACKBOMCONSUMERID">${ftcBcBomVersion.requirement_dabaodai}</td>
            <td style="text-align: left;" class="title">标签要求:</td>
            <td colspan="3" id="PACKBOMGENERICNAME">${ftcBcBomVersion.requirement_biaoqian}</td>
        </tr>
        <tr>
            <td style="text-align: left;" class="title">小标签要求:</td>
            <td colspan="3" id="PACKBOMCONSUMERID">${ftcBcBomVersion.requirement_xiaobiaoqian}</td>
            <td style="text-align: left;" class="title">卷（箱）标签要求:</td>
            <td colspan="3" id="PACKBOMGENERICNAME">${ftcBcBomVersion.requirement_juanbiaoqian}</td>
        </tr>
        <tr>
            <td style="text-align: left;" class="title">托标签要求:</td>
            <td colspan="3" id="PACKBOMCONSUMERID">${ftcBcBomVersion.requirement_tuobiaoqian}</td>
            <td style="text-align: left;" class="title">缠绕要求:</td>
            <td colspan="3" id="PACKBOMGENERICNAME">${ftcBcBomVersion.requirement_chanrao}</td>
        </tr>
        <tr>
            <td style="text-align: left;" class="title">其他要求:</td>
            <td colspan="7" id="PACKBOMCONSUMERID">${ftcBcBomVersion.requirement_other}</td>
        </tr>
    </table>
