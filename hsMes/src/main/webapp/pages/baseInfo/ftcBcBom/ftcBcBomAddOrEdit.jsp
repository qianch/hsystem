...
<div>
    <!--非套材包材bom表单-->
    <form id="ftcBcBomForm" method="post" ajax="true" action="<%=basePath %>bcBom/${empty ftcBcBom.id ?'add':'edit'}"
          autocomplete="off">
        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    <input type="text" style="width:360px" id="name" name="name" value="${ftcBcBom.name}"
            ...
            <tr>
                ...
                <td>
                    <input type="text" style="width:360px" id="code" name="code" value="${ftcBcBom.code}"
                           class="easyui-textbox" required="true" data-options="validType:['length[1,100]']">
                </td>
            </tr>
