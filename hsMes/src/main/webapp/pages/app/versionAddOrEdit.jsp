...
<div>
	<!--PDA终端版本表单-->
	<form id="appVersionForm" method="post" ajax="true" action="<%=basePath %>appVersion/${empty appVersion.id ?'add':'edit'}" autocomplete="off">
		...
		<table width="100%">
			<tr>
				...
				<!--版本号-->
				<td><input type="text" id="version" name="version" value="${appVersion.version}" class="easyui-textbox" required="true"></td>
			</tr>
			<tr>
				<td class="title">版本说明:</td>
				<!--路径-->
				<td>
					<textarea name="versionMemo" maxlength="100" style="width:100%;height:50px;resize:none;border-radius:5px;margin-left:5px;"></textarea>
				</td>
			</tr>
			<tr>
