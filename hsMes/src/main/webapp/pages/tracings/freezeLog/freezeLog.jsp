		...
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				...
				工艺名称:<input type="text" name="filter[model]" like="true" class="easyui-textbox">
					　状态:<input type="text" name="filter[logType]" in="true" class="easyui-combobox" data-options=" valueField: 'id',
       					 textField: 'text',data:[{'id':'9','text':'冻结'},{'id':'10','text':'解冻'}],onSelect:filter">
					
				</form>
			</div>
		</div>
		<table id="dg" singleSelect="false" title="" class="easyui-datagrid" url="${path}tracingLog/freezeLog/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"
		 data-options="
                singleSelect:true,
                collapsible:true,
                view:groupview,
