...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="false" title="日计划和编织计划表列表" class="easyui-datagrid"
           url="${path}weaveDailyPlanDetail/list" toolbar="#toolbar" pagination="true" rownumbers="true"
