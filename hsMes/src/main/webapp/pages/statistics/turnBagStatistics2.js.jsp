...
<script>
    ...
    $(function () {
        $('#dg').datagrid({
            url: "${path}tbStatistics/list2",
            onBeforeLoad: dgOnBeforeLoad,
        });
    });

    window.onload = function () {
        $("#start").datetimebox("setValue", new Calendar().format("yyyy-MM-dd") + " 08:00:00");
        $("#end").datetimebox("setValue", new Calendar().format("yyyy-MM-dd") + " 20:00:00");
        filter();
    };
