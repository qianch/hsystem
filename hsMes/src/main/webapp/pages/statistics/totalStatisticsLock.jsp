...
<div>
    ...
    <form id="totalStatisticsForm" method="post" ajax="true"
          action="<%=basePath %>totalStatistics/${empty type ?'lock':'unlock'}" autocomplete="off">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea style="width:257;height:132" id="reasons" name="reasons" maxlength="1500"
                              placeholder="最多个输入1500个字" required="true">
                    </textarea>
                </td>
            </tr>
        </table>
