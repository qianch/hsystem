    ...
    <div id="toolbar">
        <div style="border:0px solid #DDDDDD">
            <form action="#" id="totalStatisticsSearchForm" autoSearchFunction="false">
                条码类型:<input type="text" name="searchType" class="easyui-combobox" text="全部"
                                data-options="valueField: 'id', textField: 'text'
                                ,data:[{'id':'','text':'全部'},{'id':'roll','text':'卷条码'}
                                ,{'id':'part','text':'部件条码'},{'id':'box','text':'箱条码'}
                                ,{'id':'tray','text':'托条码'}],onSelect:filter">
                ...
                批次号:<input type="text" name="filter[batchCode]" like="true" class="easyui-textbox"></br>
                ...
                在库状态:<input type="easyui-combobox" name="filter[state]" value="" class="easyui-combobox"
                                data-options=" valueField: 'id', textField: 'text'
                                ,data:[{'id':'','text':'全部'},{'id':'1','text':'在库'}
                                ,{'id':'-1','text':'出库'},{'id':'0','text':'未入库'}]
                                ,onSelect:filter">
                冻结人:<input type="text" id="isNameLock" name="filter[isNameLock]" class="easyui-textbox" like="true">
                产出时间:<input type="text" id="start" name="filter[start]" value="" class="easyui-datetimebox">
                至:　<input type="text" id="end" name="filter[end]" value="" class="easyui-datetimebox">&nbsp;&nbsp;&nbsp;
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" toolbar="#toolbar" pagination="true"
        ...
        <tr>
            ...
            <th field="ROLLBARCODE" sortable="true" width="130"
                formatter="barcodeFormatter">条码号
            </th>
            <th field="BARCODETYPE" sortable="true" width="60"
                formatter="barcodeTypeFormatter">条码类型
            </th>
            <th field="ENDPACK" sortable="true" width='80'
                formatter="endPackFormatter">打包状态
            </th>
            <th field="STATE" sortable="true" width="80"
                formatter="stockStateFormatter">库存状态
            </th>
        </tr>
        </thead>
        <thead>
        <tr>
            ...
            <th field="ISLOCKED" sortable="true" width="80" formatter="lockStateFormatter">状态</th>
            <th field="ISABANDON" sortable="true" width="80" formatter="isAbandonFormatter">是否作废</th>
