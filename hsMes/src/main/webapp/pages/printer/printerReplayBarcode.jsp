...
<div>
    <!--打印机信息表单-->
    <form id="doPrintBarcodeForm" method="post" ajax="true" action="<%=basePath%>individualprinter/doReplayPrintBarcode"
          autocomplete="off">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <input id="pName" class="easyui-combobox" name="pName" style="width:80%"
                           data-options="panelHeight:'100',valueField:'value',textField:'text',url:'<%=basePath %>printer/getPrinterInfo'"
                           required="true">
                </td>
            </tr>
            <tr>
