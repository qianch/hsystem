...
<div>
	<!--打印机信息表单-->
	<form id="doPrintBarcodeForm" method="post" ajax="true" action="<%=basePath%>individualprinter/doIndividualPrintBarcode" autocomplete="off">
		...
		<table width="100%">
			<tr>
				...
				<td>
					<input id="pName" class="easyui-combobox" name="pName" style="width:95%" data-options="valueField:'value',textField:'text',url:'<%=basePath %>printer/getPrinterInfo'" required="true">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
       				 ...
       				 <input name="count" id="count" type="text" class="easyui-numberbox" value=${count==null?"1":count}  data-options="min:1,precision:0" style="width:265px;" required="true"></input>
				</td>	
			</tr>
			<tr>
