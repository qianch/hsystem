  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
		<div id="toolbar">
			...
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="printTemplateSearchForm" autoSearchFunction="false">
					...
					打印模版显示名称:<input type="text" name="filter[printAttributeName]" like="true" class="easyui-textbox">
		...
		<table id="dg" singleSelect="false" title="" class="easyui-datagrid"  url="${path}printTemplate/printTemplateList" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true" data-options="onDblClickRow:dbClickEdit">
			<thead>
				<tr>
					<th field="ID" checkbox=true ></th>
					<th field="PRINTATTRIBUTE" width="100">打印属性</th>
					<th field="PRINTATTRIBUTENAME" width="100">打印属性名称</th>
					<th field="TYPE" width="15" data-options="formatter:function(value,row,index){return dictFormatter('printTemplatetype',value)}" >类型</th>
