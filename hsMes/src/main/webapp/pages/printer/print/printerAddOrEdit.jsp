    ...
    <form id="printerForm" method="post" ajax="true" action="<%=basePath %>print/${empty printer.id ?'add':'edit'}"
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="printerState" name="printerState" value="${printer.printerState}"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="departmentId" name="departmentId"
                           value="${printer.departmentId}" class="easyui-combobox" required="true"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="port" name="port" value="${printer.port}" class="easyui-textbox">
                </td>
            </tr>
        </table>
    </form>
