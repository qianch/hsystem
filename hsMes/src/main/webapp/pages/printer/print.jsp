...
<div data-options="region:'west',border:true,split:true,title:'打印机列表',width:300">
    <ul class="easyui-tree"
        data-options="url:'${path }/print/printers',method:'get',animate:true,onClick:getPrinter,lines:true"></ul>
</div>
<div data-options="region:'center',border:true,title:'条码打印'">
    <table width="100%">
        <tr>
            <td class="title" style="width: 270px;">当前打印机</td>
            <td id="printer" v="" style="color:red;font-size:20px;font-weight:bold;">
                <label style="font-size:12px;color:gray;font-weight: normal;">请选择左侧打印机</label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input id="boxCount" maxlength="3" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"
                       onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入盒条码数量"/>盒
            </td>
        </tr>
        <tr>
            <td class="title">托条码数量</td>
            <td>
                <input id="trayCount" maxlength="3" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"
                       onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入托条码数量"/>托
            </td>
        </tr>
        <tr>
            <td class="title">成品胚布托条码数量</td>
            <td>
                <input style="width: auto;" id="trayPartCount" maxlength="3" type="text"
                       onkeyup="this.value=this.value.replace(/\D/g,'')"
                       onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入成品胚布托条码数量"/>托
            </td>
        </tr>
        <tr>
            <td class="title">每托条码份数</td>
            <td>
                <input style="width: auto;" id="copies" maxlength="3" type="text"
                       onkeyup="this.value=this.value.replace(/\D/g,'')"
                       onafterpaste="this.value=this.value.replace(/\D/g,'')" placeholder="请输入每托条码需打印的份数"/>份
            </td>
        </tr>
        <tr>
            <td class="title"></td>
