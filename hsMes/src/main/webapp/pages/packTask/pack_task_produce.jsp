...
<script type="text/javascript">
    ...
    const producePackTask = path + "packtask/produce/";
...
<div id="pack_task_window" class="easyui-dialog" title="包装任务" style="width:750px;height:300px;"
    ...
    <div id="pack_task_dg_toolbar">
        <a href="javascript:void(0)" plain="true" class="easyui-linkbutton" onclick="loadOrderTask()"
    ...
    <table id="pack_task_dg" singleSelect="false" fit="true" fitColumns="true"
        ...
        <tr>
            ...
            <th field="PRODUCETOTALCOUNT" width="60"
                editor="{type:'numberbox',options:{precision:0,min:1,max:9999,required:true}}">计划总托数
            </th>
        </tr>
        </thead>
    </table>
