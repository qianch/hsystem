...
var productPackTask=path+"packtask/product/";
...
<div id="pack_task_window" class="easyui-dialog" title="包装任务" style="width:750px;height:400px;" 
    ...
    <div id="pack_task_dg_toolbar">
        <a href="javascript:void(0)" plain="true" class="easyui-linkbutton" onclick="loadProductTask()" iconCls="icon-edit">重置</a>
    ...
    <table id="pack_task_dg" singleSelect="false" fit="true" fitColumns="true" 
        ...
        <thead>
            <tr>
                ...
                <th field="TOTALCOUNT" width="80" editor="{type:'numberbox',options:{precision:0,max:999999,required:true}}">订单总托数</th>
