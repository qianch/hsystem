...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
		<div id="category_toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="OnTheWayBarCode_searchForm" autoSearchFunction="false">
					<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search" onclick="filter2()">
						搜索
					</a>
				</form>
			</div>
		...
		<table id="SelectorOnTheWayBarCode_dg" singleSelect="false" title="" class="easyui-datagrid"  url="${path}planner/deliveryOnTheWayPlan/findDeliveryOnTheWayPlanDetails?deliveryId=${deliveryId}" toolbar="#toolbar1" pagination="false" rownumbers="true" fitColumns="true" fit="true"  >
			<thead>
				<tr>
