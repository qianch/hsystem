		...
		<div id="_common_producePlan_toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="_common_producePlan_dg_form" autoSearchFunction="false">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search" onclick="_common_common_producePlan_filter()">
						搜索
					</a>
				</form>
			</div>
		</div>
		<table id="_common_producePlan_dg" singleSelect="${empty singleSelect?'true':singleSelect }"  class="easyui-datagrid"  url="${path}planner/produce/list" toolbar="#_common_producePlan_toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"  data-options="onDblClickRow:dbClickEdit">
			<thead>
				<tr>
					<th field="ID" checkbox=true ></th>
					<th field="SALESORDERID" sortable="true" width="15">销售订单号</th>
					<th field="AUDITSTATE" sortable="true" width="15" formatter="_common_producePlan_formatterReviewState">审核状态</th>
					<th field="PRODUCEPLANDATE" sortable="true" width="15" formatter="_common_producePlan_formatterTime">下达日期</th>
