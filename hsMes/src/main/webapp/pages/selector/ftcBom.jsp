...
var ftcBomtreeUrl = path + "finishProduct/listFtcBom";
	 $(function(){
		 $('#ftcBomTree').tree({
			url:ftcBomtreeUrl,
...
<div class="easyui-layout" data-options="fit:true,border:false">
     <div data-options="region:'east',collapsible:false" title="非套材BOM">
	    <form id="fTc_BomForm" autoSearchFunction="false" >
			<label>搜索：</label>
			<input id="searchFtc" type="text" class="easyui-searchbox" prompt="请输入内容" searcher="searchFtcInfo" editable="true" data-options="icons:[{iconCls:'icon-clear',handler:function(e){$(e.data.target).searchbox('clear');}}]">
		</form>
