...
<script>
    //查询版本下的部件
    const find = path + "bom/tc/findParts";
    ...
    <div data-options="region:'north',collapsible:false" title="" height="150px">
        ...
        <table width="100%" title="版本列表">
            <tr>
                ...
                <td>
                    <input type="text" data-options="required:true,validType:'length[1,20]','icons':{}" editable=false
                           id="tcProcBomVersionCode" name="tcProcBomVersionCode"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="tcProcBomVersionEnabled" editable=false name="tcProcBomVersionEnabled"
                           value="${tcBomVersion.tcProcBomVersionEnabled}" class="easyui-combobox" readOnly="true"
                           panelHeight="auto" editable="false" data-options="data: [
	                        {value:'1',text:'启用'},
	                        {value:'-1',text:'未启用'}
                    	],'icons':{}">
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="tcProcBomVersionDefault" disable=false readOnly="true"
                           name="tcProcBomVersionDefault" value="${tcBomVersion.tcProcBomVersionDefault}"
                           class="easyui-combobox" panelHeight="auto" editable="false" data-options="data: [
	                        {value:'1',text:'是'},
	                        {value:'-1',text:'否'}
                    	],'icons':{}">
                </td>
