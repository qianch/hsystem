		...
		<form id="ftcBomVersionForm" method="post" ajax="true" autocomplete="off">
			...
			<table width="100%">
				<tr>
					...
					<!--版本号-->
					<td><input type="text" value="${ftcBomVersion.ftcProcBomVersionCode}" class="easyui-textbox" readonly="true"></td>
				</tr>
				<tr>
					<td class="title">是否启用:</td>
					<!--是否启用，-1不启用，1启用-->
					<td><input type="text" value="${ftcBomVersion.ftcProcBomVersionEnabled==-1?'不启用':'启用'}" class="easyui-textbox" readonly="true"></td>
				</tr>
				<tr>
					<td class="title">是否默认:</td>
					<!--是否默认，-1不是默认，1默认-->
					<td><input type="text" value="${ftcBomVersion.ftcProcBomVersionDefault==-1?'非默认':'默认'}" class="easyui-textbox" readonly="true"></td>
				</tr>
			</table>
		</form>
	</div>
	<div data-options="region:'center'">
		<table id="_common_ftcBom_detail" singleSelect="false" title="非套材Bom明细" class="easyui-datagrid" url="" rownumbers="true" fitColumns="true" fit="true">
			<thead>
				<tr>
