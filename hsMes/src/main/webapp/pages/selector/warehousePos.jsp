...
<div id="_common_warehousePos_toolbar">
	<div style="border-top:1px solid #DDDDDD">
		<form action="#" id="_common_warehousePos_dg_form" autoSearchFunction="false">
			<label class="panel-title">搜索：</label> 库位代码:<input type="text" name="filter[code]" like="true" class="easyui-textbox"> 库位名称:<input type="text" name="filter[code]" like="true" class="easyui-textbox"> <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small"
				iconcls="icon-search" onclick="_common_warehousePos_filter()"> 搜索 </a>
		</form>
	</div>
</div>
<table id="_common_warehousePos_dg" singleSelect="${empty singleSelect?'true':singleSelect }" class="easyui-datagrid" url="${path}warehosePos/list" toolbar="#_common_warehousePos_toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true" >
	<thead>
		<tr>
