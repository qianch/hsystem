...
<script type="text/javascript">
    ...
    function getChildren(ids, _common_user_treeNode) {
        ...
        if (_common_user_treeNode.isParent) {
            for (const obj in _common_user_treeNode.children) {
            ...
            <div style="border-top:1px solid #DDDDDD">
                <form action="#" id="_common_user_dg_form" autoSearchFunction="false">
                    ...
                    <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search"
                       onclick="_common_user_filter()">搜索
                    </a>
                </form>
            </div>
        </div>
        <table id="_common_user_dg" singleSelect="${empty singleSelect?'true':singleSelect }" fit="true"
               class="easyui-datagrid" url="<%=basePath %>user/list" toolbar="#_common_user_toolbar" pagination="true"
