...
<div data-options="region:'center',border:false" style="position: relative; ">
    <div style="border-top:1px solid #DDDDDD">
        <form action="#" id="_common_complaintSearchForm" autoSearchFunction="false">
            ...
            <input type="text" name="_common_complaint_filter[data]" like="true" class="easyui-textbox"
                   placeholder="请输入查询条件">
            <input type="text" name="_common_complaint_filter[time]" like="true" class="easyui-datebox">
            <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search"
               onclick="_common_complaint_filter()">
                搜索
            </a>
        </form>
    </div>
</div>
<table id="_common_complaint_dg" singleSelect="${empty singleSelect?'true':singleSelect }" title="投诉列表"
       class="easyui-datagrid" url="${path}complaint/list"
