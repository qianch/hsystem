...
<script type="text/javascript">
    //树
    const _common_device_treeListUrl = path + "deviceType/list";
            ...
            <div style="border-top:1px solid #DDDDDD">
                <form action="#" id="_common_device_dg_form" autoSearchFunction="false">
                    ...
                    <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search"
                       onclick="_common_device_filter()">
                        搜索
                    </a>
                </form>
            </div>
        </div>
        <table id="_common_device_dg" idField="ID" singleSelect="${empty singleSelect?'true':singleSelect }"
               title="设备信息列表" class="easyui-datagrid" toolbar="#_common_device_toolbar" pagination="true"
