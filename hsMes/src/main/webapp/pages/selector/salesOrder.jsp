...
<div id="_common_salesOrder_toolbar">
	<div style="border-top:1px solid #DDDDDD">
		<form action="#" id="_common_salesOrder_dg_form" autoSearchFunction="false">
			...
			<br>
			订单类型:<input type="text" name="filter[orderType]"class="easyui-combobox" data-options="valueField:'v',textField:'t',data:[{'v':'1','t':'常规'},{'v':'2','t':'试样'},{'v':'3','t':'新品'},{'v':'-1','t':'未知'}],onSelect:_common_salesOrder_filter">
			内销外销:<input type="text" name="filter[export]"class="easyui-combobox" data-options="valueField:'v',textField:'t',data:[{'v':'1','t':'内销'},{'v':'0','t':'外销'}],onSelect:_common_salesOrder_filter">
			<br>
			客户名称:<input type="text" id="_common_consumerName" name="filter[consumerName]" like="true" class="easyui-textbox">
			<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search" onclick="_common_salesOrder_filter()">
				搜索
			</a>
		</form>
	</div>
</div>
<table id="_common_salesOrder_dg" idField="SALESORDERCODE" singleSelect="${empty singleSelect?'true':singleSelect }" class="easyui-datagrid"  url="${path}salesOrder/list" toolbar="#_common_salesOrder_toolbar" pagination="true"  data-options="rowStyler:_common_salesOrder_rowStyler" fit="true">
	<thead>
		<tr>
