...
<script type="text/javascript">
    ...
    let _common_product_dgenableFilter = false;
        ...
        $('#_common_product_dg').datagrid({
            ...
            onLoadSuccess: function (data) {
                if (!_common_product_dgenableFilter) {
                    const cs = [{'field': 'CONSUMERCODE', 'type': 'textbox'}, {
                        'field': 'CONSUMERNAME',
                        'type': 'textbox'
                    }, {'field': 'FACTORYPRODUCTNAME', 'type': 'textbox'}, {
                        'field': 'ISCOMMON',
                        'type': 'textbox'
                    }, {'field': 'AUDITSTATE', 'type': 'textbox'}, {
                        'field': 'CONSUMERPRODUCTNAME',
                        'type': 'textbox'
                    }, {'field': 'PRODUCTMODEL', 'type': 'textbox'}, {
                        'field': 'PRODUCTWIDTH',
                        'type': 'textbox'
                    }, {'field': 'PRODUCTROLLLENGTH', 'type': 'textbox'}, {
                        'field': 'PRODUCTROLLWEIGHT',
                        'type': 'textbox'
                    }, {'field': 'PRODUCTPROCESSCODE', 'type': 'textbox'}, {
                        'field': 'PRODUCTPROCESSBOMVERSION',
                        'type': 'textbox'
                    }, {'field': 'PRODUCTCONSUMERBOMVERSION', 'type': 'textbox'}, {
                        'field': 'PRODUCTPACKAGINGCODE',
                        'type': 'textbox'
                    }, {'field': 'PRODUCTPACKAGEVERSION', 'type': 'textbox'}, {
                        'field': 'PRODUCTMEMO',
                        'type': 'textbox'
                    },
                        {
                            'field': 'PRODUCTISTC', 'type': 'combobox', options: {
                                icons: [],
                                panelHeight: 'auto',
                                data: [{value: "", text: "全部"}, {value: "套材", text: "套材"}, {
                                    value: "非套材",
                                    text: "非套材"
                                }],
                                onChange: function (nv, ov) {
                                    if (isEmpty(nv)) {
                                        ...
                                        $('#_common_product_dg').datagrid("addFilterRule", {
                                            field: 'PRODUCTISTC',
                                            op: 'equal',
                                            value: nv
                                        });
...
<div id="_common_product_toolbar">
    ...
    <div style="border-top:1px solid #DDDDDD">
        <form action="#" id="_common_product_dg_form" style="display:none" autoSearchFunction="false">
            ...
            <input type="hidden" id="productIsTc" name="filter[productIsTc]" in="true"
                   value="${empty isShow ?'-1':'1,2'}"><!-- 标识是否需要显示裁剪添加的胚布 -->
            ...
            产品型号：<input id="_common_productModel" type="text" name="filter[productModel]" like="true"
...
<table id="_common_product_dg" width="100%" height="98%" idField="ID"
       data-options="onBeforeLoad:_commons_product_dg_onBeforeLoad,pageSize:10000,nowrap:false,rowStyler:productStyler"
       class="easyui-datagrid" url="<%=basePath %>finishProduct/listAll" toolbar="#_common_product_toolbar"
