		...
		<div id="category_toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="carrier_searchForm" autoSearchFunction="false">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search" onclick="filter1()">
						搜索
					</a>
				</form> 
			</div>
		</div>
		<table id="weight_dg" singleSelect="true" title="" class="easyui-datagrid"  url="${path}weightCarrier/list" toolbar="#category_toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"  >
			<thead>
				<tr>
