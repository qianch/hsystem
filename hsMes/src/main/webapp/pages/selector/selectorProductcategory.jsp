...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
		...
		<table id="category_dg" singleSelect="true" title="" class="easyui-datagrid"  url="${path}product/category/list" toolbar="#category_toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"  >
			<thead>
				<tr>
