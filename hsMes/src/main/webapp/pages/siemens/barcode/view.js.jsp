...
<script>
	var treeUrl=path+"siemens/fragmentBarcode/view/tree?code=";
			...
			$('#tree').tree(
					{
						...
						formatter:function(node){
							if(node.text.charAt(0)=='P'){
								var root="<font style=\'font-weight:bold\'>"+node.text.toUpperCase()+"</font>";
								try {
	...
	var url=path+"siemens/fragmentBarcode/view";
	function query(code){
		Loading.show();
