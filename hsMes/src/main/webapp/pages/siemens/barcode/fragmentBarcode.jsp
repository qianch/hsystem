    ...
    <div id="toolbar">
        ...
        <div id="p" class="easyui-panel" title="查询"
            ...
            <form action="#" id="fragmentBarcodeSearchForm" autoSearch="true" autoSearchFunction="false">
                ...
                组套状态:<input type="text" class="easyui-combobox" name="filter[ISPACKED]"
                                data-options="valueField:'v',textField:'t',data:[{'v':'',t:'全部'},{'v':'0',t:'未组套'},{'v':'1',t:'已组套'}],onChange:filter">
                ...
                组套时间:<input type="text" id="PACKEDTIME_S" class="easyui-datetimebox" name="filter[PACKEDTIME_S]"
                                data-options="onSelect:filter">
                　　至　 <input type="text" id="PACKEDTIME_E" class="easyui-datetimebox" name="filter[PACKEDTIME_E]"
                             data-options="onSelect:filter">
                打印时间:<input type="text" id="PRINTTIME_S" class="easyui-datetimebox" name="filter[PRINTTIME_S]"
                                data-options="onSelect:filter">
                　　至　 <input type="text" id="PRINTTIME_E" class="easyui-datetimebox" name="filter[PRINTTIME_E]"
                             data-options="onSelect:filter">
                　　　　　<a class="easyui-linkbutton" iconcls="icon-search" onclick="filter()"> 搜索 </a>
            </form>
        </div>
    </div>
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" url="${path}siemens/fragmentBarcode/list"
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td style="padding:5px;padding-left:0px;">
                <input type="text" id="printer" class="easyui-combobox" style="width:80%!important;"
        ...
        <tr>
            ...
            <td style="padding:5px;">
                <textarea id="reason" style="width:80%;height:100px;padding:5px;border-radius:5px;resize:none;"
