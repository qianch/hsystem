        ...
        function review() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    let farbics = "";
                    for (let i = 0; i < data.farbic.length; i++) {
...
<body>
<div class="input">
    <input type="text" id="barcode" spellcheck="false" onkeyup="this.value=this.value.toUpperCase()"
           onkeydown="key(event)" maxlength="20" placeholder="请输入小部件条码号"/>
    <button onclick="review()">查询</button>
</div>
<table class="items">
    <tr class="header">
        <td>
            <div class="icon icon-farbic"></div>
        </td>
        ...
        <td style="background: #cecece;border:none;"></td>
        <td>
            <div class="icon icon-barcode"></div>
        </td>
        <td style="background: #cecece;border:none;"></td>
        <td>
            <div class="icon icon-suit"></div>
        </td>
    </tr>
