  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
		<div id="toolbar">
			<div id="p" class="easyui-panel" title="查询" style="width:100%;height:210px; padding:5px;background:rgb(250, 250, 250);" data-options="iconCls:'icon-search',collapsible:true,onExpand:resizeDg,onCollapse:resizeDg">
	            <form action="#" id="suitErrorLogSearchForm" autoSearch="true" autoSearchFunction="false">
						...
						　　打印类型:<input type="text" class="easyui-combobox" name="filter[FRAGMENTPRINTTYPE]" data-options="valueField:'v',textField:'t',data:[{'v':'',t:'全部'},{'v':'常规',t:'常规'},{'v':'补打',t:'补打'},{'v':'重打',t:'重打'}],onChange:filter">
						...
						　　客户简称:<input type="text" class="easyui-textbox" like="true" name="filter[FRAGMENTCONSUMERSIMPLENAME]">
						　　客户大类:<input type="text" class="easyui-combobox" name="filter[CONSUMERCATEGORY]" data-options="valueField:'v',textField:'t',data:[{'v':'',t:'全部'},{'v':'国内',t:'国内'},{'v':'国外',t:'国外'}],onChange:filter">
						...
						开始扫描时间:<input type="text" id="SCANTIME_S" class="easyui-datebox" name="filter[SCANTIME_S]" data-options="onSelect:filter"> 
						结束扫描时间:<input type="text" id="SCANTIME_E" class="easyui-datebox" name="filter[SCANTIME_E]" data-options="onSelect:filter">
		...
		<table id="dg" singleSelect="false" class="easyui-datagrid"  url="${path}siemens/barcode/suitErrorLog/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="false" fit="true">
