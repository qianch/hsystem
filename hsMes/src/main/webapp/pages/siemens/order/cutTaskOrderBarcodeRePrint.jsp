    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td style="padding:5px;padding-left:0px;">
                <input type="text" id="rePrinter" class="easyui-combobox" style="width:80%!important;"
        ...
        <tr>
            ...
            <td style="padding:5px;padding-left:0px;">
                <input type="text" id="rePrintCount" class="easyui-numberspinner" style="width:80%!important;"
        ...
        <tr>
            ...
            <td style="padding:5px;">
                <textarea id="reason" style="width:80%;height:50px;padding:5px;border-radius:5px;resize:none;"
