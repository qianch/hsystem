        ...
        <div id="p" class="easyui-panel" title="查询"
            ...
            <form action="#" id="cutTaskSearchForm" autoSearch="true" autoSearchFunction="false">
                ...
                客户大类:<input type="text" class="easyui-combobox" name="filter[CONSUMERCATEGORY]"
                                data-options="valueField:'v',textField:'t',data:[{v:'',t:'全  部'},{v:'1',t:'国内'},{v:'2',t:'国外'}],onChange:filter">
                <br>
...
<div id="dlg" class="easyui-dialog" title="创建派工单" style="width:600px;height:400px;"
    ...
    <div class="easyui-layout" style="width:100%;height:100%;">
        <div data-options="region:'north',border:'none'" style="height:165px">
            <form style="margin: 0;" id="cutTaskForm" method="post" ajax="true"
                  action="<%=basePath %>cutTask/${empty cutTask.id ?'add':'edit'}" autocomplete="off">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <!--任务单编号-->
                        <td>
                            <input type="text" id="ctoCode" name="ctoCode" class="easyui-textbox"
