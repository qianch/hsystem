        ...
        <div data-options="region:'north',border:false" style="height:238px">
            <form style="margin: 0;" id="cutTaskForm2" autoSearchFunction="false">
                <table width="100%">
                    <tr>
                        <td colspan="4"
                            style="height:70px;text-align: center;font-size: 20px;font-weight: bold;vertical-align: middle;">
                            裁剪派工单
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="ctoCode2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                        <td class="title">任务单号:</td>
                        <td>
                            <input type="text" id="taskCode2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" id="orderCode2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                        <td class="title">批次号:</td>
                        <td>
                            <input type="text" id="batchCode2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" id="consumerSimpleName2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                        <td class="title">客户大类:</td>
                        <td>
                            <input type="text" id="taskConsumerCategoryX2" class="easyui-textbox"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="partName2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                        <td class="title">交货日期:</td>
                        <td>
                            <input type="text" id="deliveryDate2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" id="ctoGroupLeader2" class="easyui-combobox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                        <td class="title">班组:</td>
                        <td>
                            <input type="text" id="ctoGroupName2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" id="suitCount2" class="easyui-textbox" data-options="icons:[]"
                                   editable="false" required="true">
                        </td>
                        <td class="title">派工套数:</td>
                        <td>
                            <input type="text" id="assignCount2" name="assignSuitCount2" class="easyui-textbox"
                                   precision="0" data-options="icons:[],min:1" editable="false" required="true">
                        </td>
                    </tr>
                </table>
            </form>
