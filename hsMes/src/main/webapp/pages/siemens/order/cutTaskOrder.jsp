  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
			...
			<div style="border-top:1px solid #DDDDDD">
				<div id="p" class="easyui-panel" title="查询" style="width:100%;height:120px; padding:5px;background:rgb(250, 250, 250);" data-options="iconCls:'icon-search',collapsible:true,onExpand:resizeDg,onCollapse:resizeDg">
			            <form action="#" id="cutTaskOrderSearchForm" autoSearch="true" autoSearchFunction="false">
								...
								客户大类:<input type="text" class="easyui-combobox" name="filter[CONSUMERCATEGORY]" data-options="valueField:'v',textField:'t',data:[{'v':'',t:'全部'},{'v':'1',t:'国内'},{'v':'2',t:'国外'}],onChange:filter">
								<br>
		...
		<table id="dg" singleSelect="false" title="" class="easyui-datagrid"  url="${path}siemens/cutTaskOrder/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"
				data-options="
				rowStyler:styler,
				view: detailview,
