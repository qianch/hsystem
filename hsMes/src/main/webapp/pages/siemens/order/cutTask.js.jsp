...
//添加西门子裁剪任务单
var addUrl=path+"cutTask/add";
//编辑西门子裁剪任务单
var editUrl=path+"cutTask/edit";
//删除西门子裁剪任务单
var deleteUrl=path+"cutTask/delete";
...
function exportTask(){
	var url=path+"excel/export/裁剪任务单/com.bluebirdme.mes.siemens.excel.CutTaskExportHandler/filter?"+JQ.getFormAsString("cutTaskSearchForm");
	location.href=url;
}
