...
<div id="suitDlg" class="easyui-dialog" title="组套BOM" style="width:600px;height:100%;overflow: hidden;"
            data-options="
                ...
                modal:true
            ">
<table id="viewSuitDg" singleSelect="false" class="easyui-datagrid" pagination="false" rownumbers="true" fitColumns="false" remoteSort="false" fit="true">
	<thead>
		<tr>
...
<div id="drawingsDlg" class="easyui-dialog" title="图纸BOM" style="width:600px;height:100%;overflow: hidden;"
            data-options="
                ...
                modal:true
            ">
<table id="viewDrawingsDg" idField="id" singleSelect="false" class="easyui-datagrid" pagination="false" rownumbers="true" fitColumns="true" remoteSort="false" fit="true">
	<thead>
		<tr>
			<th field="id" checkbox="true"></th>
