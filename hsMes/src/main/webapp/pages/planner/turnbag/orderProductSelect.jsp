...
function alloCate(){
	...
	console.log(isCheck);
	if(isCheck){
		var data=$('#orderProductSelect').datagrid('getRows');
		var newData=[];
		console.log(data);
...
<table width="100%" id="orderProductSelect" idField="ID" toolbar="#produceSalesOrderSearchToolbar" singleSelect="true" title="" class="easyui-datagrid"  
