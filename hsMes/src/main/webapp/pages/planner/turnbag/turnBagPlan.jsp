...
<body class="easyui-layout" data-options="fit:true,border:true">
	<div data-options="region:'west',split:true,border:true,collapsible:true" title="翻包计划列表" style="width:600px">
		<div id="toolbar">
			...
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="turnBagPlanSearchForm" autoSearch="" autoSearchFunction="false">
					翻包单号:<input type="text" name="filter[trunBagCode]" like="true" class="easyui-textbox" style="width:100px"> 下单人:<input type="text" name="filter[userName]" like="true" class="easyui-textbox" style="width:100px"> 翻包部门:<input type="text" name="filter[departmentName]"
						like="true" class="easyui-textbox" style="width:100px"><br/> 订单号:<input type="text" name="filter[orderCode]" like="true" class="easyui-textbox" style="width:100px">  <input type="text" id="start" name="filter[start]" value="" prompt="开始时间" class="easyui-datetimebox" data-options="onChange:filter"> 
		...
		<table id="dg" singleSelect="true" class="easyui-datagrid" url="${path}planner/tbp/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"
	...
	<div data-options="region:'center'" title="翻包任务详情">
		...
		<table id="details" title="待翻包订单" singleSelect="true" class="easyui-datagrid" fitColumns="false" style="width:100%;" toolbar="#toolbar_product">
			<thead  frozen="true">
				<tr>
