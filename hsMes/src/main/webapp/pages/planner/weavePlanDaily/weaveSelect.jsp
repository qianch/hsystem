...
<div>
	<!--日计划表单-->
	<form style="height:97%" id="weaveDailyPlanForm" method="post" ajax="true" action="<%=basePath %>weaveDailyPlan/${empty weaveDailyPlan.id ?'add':'edit'}" autocomplete="off">
		...
		<table id="dgg2" toolbar="#dgg_toolbar" idField="ID" width="100%" singleSelect="false" class="easyui-datagrid" 
			url="<%=basePath %>weaveDailyPlan/findWeavePlan?filter[workShop]=${workShop}" pagination="false" rownumbers="true" fitColumns="false" fit="true"
			data-options="onLoadSuccess:ddg2LoadSuccess,onDblClickRow:onDgg2DbClick,rowStyler:planIsSettledStyler" remoteFilter="false" remoteSort="false"> 
			<thead frozen="true">
				<tr>
