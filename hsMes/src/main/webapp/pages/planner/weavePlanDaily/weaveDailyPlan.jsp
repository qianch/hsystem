	...
	<div data-options="region:'center',border:false">
		<div class="easyui-layout" data-options="fit:true,border:false">
			<div data-options="region:'center',border:true">
				...
				<table id="dailyDetails" width="100%" singleSelect="true" title="日计划明细" class="easyui-datagrid" pagination="false" rownumbers="true" fitColumns="false" fit="true" toolbar="#toolbar1"
                ...
                if(value==4){
					...
					<thead>
						<tr>
							...
							<th field="PRODUCEDTOTALWEIGHT" sortable="true" width="80" formatter="processFormatter" styler="processStyler">生产进度</th>
				...
				<div class="easyui-layout" fit="true">
					<div class="easyui-layout" data-options="region:'layout',border:false,fit:true">
						<div data-options="region:'center',border:false" style="">
							<table id="dailyDeviceDg" singleSelect="true" idField="DEVICEID" class="easyui-datagrid" title="生产机台" style="width:100%height:250px" fit="true" fitColumns="true">
								<thead>
									<tr>
	...
	<div data-options="region:'west',border:true,width:420,collapsible:true">
		<div id="toolbar">
			<form id="deviceSearchForm" autoSearchFunction="false">
				日期:<input type="text" class="easyui-datebox" name="filter[produceDate]" style="width:120px;" data-options="onSelect:filter"> 
				车间:<input type="text" id="workshop" name="filter[workshop]" class="easyui-combobox" style="width:130px;"
						  data-options="valueField:'v',textField:'t',url:'<%=basePath %>department/queryDepartmentByType?type=weave'"> <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-search"
					onclick="filter()"> 搜索 </a>
			</form>
			<hr>
			<jsp:include page="../../base/toolbar.jsp">
		...
		<table id="dg" singleSelect="true" title="日计划列表" class="easyui-datagrid" url="<%=basePath%>weaveDailyPlan/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true" data-options="onClickRow:dgRowClick,onLoadSuccess:dgLoadSuccess,rowStyler:formatterIsClosed">
			<thead>
				<tr>
