...
<div id="planDgToolbar">
    <form id="planDgFrom" autoSearchFunction="false">
        ...
        <a href="javascript:void(0)" plain="true" class="easyui-linkbutton" onclick="searchPlanDg()" id="addPlan"
           iconCls="icon-search">搜索</a>
    </form>
</div>
<table id="planDg" toolbar="#planDgToolbar" class="easyui-datagrid" singleSelect="false" title=""
       url="<%=basePath%>weaveDailyPlan/findWeavePlan" pagination="false" rownumbers="true" fit="true" fitColumns="true"
       data-options="onLoadSuccess:loadSuccessCallback">
    <thead>
    <tr>
