    ...
    <form id="weavePlanForm" method="post" ajax="true"
        ...
        <table width="100%">
            <tr>
                ...
                <!--产品属性-->
                <td>
                    <input type="text" id="productType" name="productType" value="${weavePlan.productType}"
                ...
                <td>
                    <input type="text" id="weight" name="requirementCount"
                           value="${weavePlan.requirementCount}"  ${empty weavePlan.requirementCount?"":"readonly"}
                           class="easyui-numberbox" min="1" required="true">
                </td>
            </tr>
            <tr>
                <td class="title">总托数:</td>
                <td>
                    <input type="text" id="productTrayCount" name="totalTrayCount" value="${weavePlan.totalTrayCount}"
                           readonly="true" precision="0" min="1" class="easyui-numberbox">
                </td>
                <td class="title">总卷数:</td>
                <td>
                    <input type="text" id="count" name="totalRollCount"
                           value="${weavePlan.totalRollCount}" ${empty weavePlan.totalRollCount?"":"readonly"} min="1"
                           class="easyui-numberbox" precision="0" required="true">
                </td>
            </tr>
            <tr>
        ...
        <div id="deviceToolbar">
            <a href="javascript:void(0)" plain="true" class="easyui-linkbutton" onclick="ChooseDevice()" id="addDevice"
               iconCls="icon-add">增加机台</a>
            <a href="javascript:void(0)" plain="true" class="easyui-linkbutton" onclick="deleteDevice()"
               id="deleteDevice" iconCls="icon-remove">移除机台</a>
        </div>
        <table id="deviceDg" idField="DEVICEID" class="easyui-datagrid" singleSelect="true" title="生产机台"
               style="width:100%;height:250px" toolbar="#deviceToolbar"
               data-options="onClickRow:deviceRowClick,onAfterEdit:onAfterEdit">
            <thead>
            <tr>
                ...
                <th data-options="field:'PRODUCECOUNT',width:80,editor:{type:'numberbox',options:{required:true,min:1,precision:0}}">
                    生产数量
                </th>
            </tr>
            </thead>
