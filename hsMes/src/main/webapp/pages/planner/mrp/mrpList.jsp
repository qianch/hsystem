    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',split:false,border:false"
            ...
            <form action="#" id="salesOrderSearchForm" style="text-align: left"
                ...
                时间:<input type="text" name="filter[begin]" like="false" class="easyui-datebox" style="width: 115px"
                            prompt="开始时间">
                至<input type="text" name="filter[end]" like="false" class="easyui-datebox" style="width: 115px"
                         prompt="结束时间"></br>
                单号:<input type="text" name="filter[code]" like="true" class="easyui-textbox" style="width: 200px"
                            prompt="生产或者订单号">
            ...
            <div class="datagrid-toolbar"
                ...
                <a href="javascript:void(0)" style="color:#0E2D5F;" onClick="allSelect()">全选</a>&nbsp
                <a href="javascript:void(0)" style="color:#0E2D5F;" onClick="unAllSelect()">取消</a>
            </div>
        </div>
        <div data-options="region:'center',border:false"
             style="overflow-x:hidden;">
            <ul id="dl" class="easyui-datalist" checkbox="true" singleSelect="false" lines="true" style="width:100%;"
                valueField="ID" textField="PRODUCEPLANCODE" data-options="onSelect:loadMrp,onUnselect:loadMrp">
            </ul>
        </div>
    </div>
</div>
<div data-options="region:'center',border:false"
    ...
    <table id="dg_ftc" title="原料需求" style="width:100%;height:48%" class="easyui-datagrid" rownumbers="true"
           fitColumns="true" data-options="onLoadSuccess:onLoadSuccess">
        <thead>
        <tr>
    ...
    <table id="dg_bc" title="包材需求" style="width:100%;"
        ...
        <tr>
            ...
            <th field="PACKMATERIATOTALCOUNT" width="15"
                formatter="numberFormatter2">需要数量
            </th>
        </tr>
        </thead>
    </table>
