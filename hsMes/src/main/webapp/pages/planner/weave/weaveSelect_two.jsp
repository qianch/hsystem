...
<script type="text/javascript">
    $(function () {
        $("#dgg2").datagrid({
            url: encodeURI("<%=basePath %>planner/weavePlan/findUnCompletedWeavePlan?filter[workShop]=${workShop}&filter[isTurnBagPlan]=生产")
        })
    });
...
<div style="height:100%;">
    ...
    <div id="_weave_plan_select_">
        <form id="_weave_plan_select_form" autoSearchFunction="_weave_plan_select_search" autoSearchFunction="false">
            ...
            门&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp幅:<input type="text" class="easyui-textbox" like="true"
                                                      name="filter[productwidth]">
            米&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp长:&nbsp<input type="text" class="easyui-textbox" like="true"
                                                           name="filter[productlength]">
            <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search"
               onclick="_weave_select_filter()"> 搜索 </a>
        </form>
    </div>
    <table id="dgg2" idField="ID" width="100%" singleSelect="false" class="easyui-datagrid" style="height:100%;"
           toolbar="#_weave_plan_select_"
        ...
        <tr>
            ...
            <th field="PARTID" sortable="true" width="150" style="display:none;">部件ID</th>
