    ...
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form id="wpSearchForm" action="#" autoSearchFunction="false">
                <input type="text" id="workShop" name="filter[workShopCode]" like="false" class="easyui-combobox"
                       prompt="请选择车间"
                       data-options="valueField:'v',textField:'t',url:'<%=basePath %>department/queryDepartmentByType?type=weave'">
                <input type="text" class="easyui-textbox" prompt="生产计划单号" name="filter[code]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="销售单号" name="filter[saleCode]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="产品规格" name="filter[model]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="批次号" name="filter[batchCode]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="米长" name="filter[productLength]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="门幅" name="filter[productWidth]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="工艺代码" name="filter[processBomCode]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="工艺版本" name="filter[processBomVersion]" like="true"
                       data-options="onChange:filter">
                <input type="text" class="easyui-textbox" prompt="客户名称" name="filter[consumerName]" like="true"
                       data-options="onChange:filter">
                <input type="text" value="-1" name="filter[isFinish]" class="easyui-combobox"
                       prompt="已完成选项" data-options="onSelect:filter,onChange:filter,data: [
		                       {value:'3',text:'全部'},  {value:'-1',text:'未完成'}, {value:'1',text:'已完成'}]">
                <input type="text" value="0" name="filter[closed]" class="easyui-combobox"
...
<div id="w" class="easyui-dialog" title="" data-options="closed:true,buttons: '#dlg-buttons',onOpen:loadData"
     style="width:700px;height:400px;">
    <table id="dg_view" singleSelect="false" title="" class="easyui-datagrid" rownumbers="true" fitColumns="false"
           fit="true" data-options="rowStyler:rowStyler,showFooter:true">
        <thead>
        <tr>
            <th field="PLANCODE" sortable="true" width="160">生产计划单号</th>
            <th field="SALESORDERSUBCODE" sortable="true" width="130">销售订单号</th>
