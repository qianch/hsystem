...
<script>
	...
	$(function(){
		var url = encodeURI("${path}planner/cut/turnbag/cutList?filter[isTurnBagPlan]=翻包");
		$('#dg').datagrid({
			url:url,
	...
	function printBoxCode(){
		...
		var wid1 = Dialog.open("托条码打印", 419, 200,path+"planner/produce/pack/turnbag" , [ EasyUI.window.button("icon-save", "打印", function() {
	...
	function printTrayCode(){
		...
		//log(r.PRODUCEPLANDETAILID)
		var wid1 = Dialog.open("部件条码打印", 419, 200,path+"planner/produce/pack/turnbag?fromSalesOrderDetailId="
