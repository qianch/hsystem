...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false"
		...
		<div id="toolbar">
			...
			<a href="javascript:void(0)" plain="true" class="easyui-linkbutton" onclick="printTrayCode()" id="printTrayCode" iconCls="icon-print">打印部件条码</a>
			...
			<div style="border-top:1px solid #DDDDDD">
				<form id="wpSearchForm" action="#" autoSearchFunction="false">
					车　　间:<input type="text" id="workShop" name="filter[workShopCode]" like="false" class="easyui-combobox" prompt="请选择车间"
		           	...
		           	完成状态:<input type="text" id="finishStatus" value="-1" name="filter[isFinish]" class="easyui-combobox" prompt="已完成选项"  data-options="onSelect:filter,onChange:filter,data: [
		                       {value:'3',text:'全部'},  {value:'-1',text:'未完成'}, {value:'1',text:'已完成'}]">
		           	关闭状态:<input type="text" id="closeStatus" value="0" name="filter[closed]" class="easyui-combobox" prompt="已关闭选项"  data-options="onSelect:filter,onChange:filter,data: [
