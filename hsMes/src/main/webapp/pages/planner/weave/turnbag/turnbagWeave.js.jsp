...
<script>
    ...
    $(function () {
        const url = encodeURI("${path}planner/weave/turnbag/weaveList?filter[isTurnBagPlan]=翻包");
        $('#dg').datagrid({
            url: url,
    ...
    function printBoxCode() {
        ...
        const wid1 = Dialog.open("托条码打印", 419, 200, path + "planner/produce/pack/?producePlanDetailId=" + r.PRODUCEPLANDETAILID + "&print=true", [EasyUI.window.button("icon-save", "打印", function () {
