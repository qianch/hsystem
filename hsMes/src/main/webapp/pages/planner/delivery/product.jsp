...
<div id="_common_product_toolbar">
    <div style="border-top:1px solid #DDDDDD">
        <form action="#" id="_common_product_dg_form">
            <input type="hidden" id="commonProductIds" in="true" name="filter[id]" value="${ids}">
        </form>
    </div>
</div>
<table id="_common_product_dg" width="100%" height="98%" idField="ID"
    ...
    <tr>
        ...
        <th field="CONSUMERCODE" width="60" sortable="true">客户代码</th>
        ...
        <th field="ISCOMMON" sortable="true" width="50"
            formatter="formatterIscommon">产品属性
        </th>
        <th field="AUDITSTATE" sortable="true" width="100"
            formatter="formatterReviewState">审核状态
        </th>
    </tr>
    </thead>
    <thead>
