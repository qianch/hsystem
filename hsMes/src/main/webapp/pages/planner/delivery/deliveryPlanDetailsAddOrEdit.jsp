...
<div>
    ...
    <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
       onclick="add_dg_delivery_product_detail()">增加</a>
    <a href="#" class="easyui-linkbutton" iconCls="icon-delete" plain="true"
       onclick="doDelete_dg_delivery_product_detail()">删除</a>
    <table id="dg_delivery_product_detail" title="发货产品明细" class="easyui-datagrid" url="" rownumbers="true">
        <thead>
        <tr>
