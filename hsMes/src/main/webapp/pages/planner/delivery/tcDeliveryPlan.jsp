...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false"
		...
		<div id="toolbar">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconcls="platform-icon9" onclick="exportExcel()">导出</a>
		...
		<table id="dg" singleSelect="false" title=""
			class="easyui-datagrid" url="${path}planner/deliveryPlan/tcList"
