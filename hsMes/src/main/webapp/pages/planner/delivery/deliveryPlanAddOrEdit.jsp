        ...
        <table style="width: 100%">
            <tr>
                ...
                <td><input type="text" id="packagingType" name="packagingType"
                           style="width: 95%;//宽度 height=20px;//高度" value="${deliveryPlan.packagingType}"
            ...
            <tr>
                ...
                <td width="27%"><input type="text" id="deliveryTargetCompany"
                ...
                <!--条码-->
                <td width="27%"><input type="text" id="barcode" name="barcode"
                                       style="width: 95%;//宽度 height=20px;//高度"
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td><textarea id="sampleInformation" name="sampleInformation"
                              ...
                              placeholder="1000字以内">${deliveryPlan.sampleInformation}</textarea></td>
                <!--样布信息-->
            </tr>
        </table>
        <table style="width: 100%">
            ...
            <table id="dg_product" singleSelect="false" title="产品" class="easyui-datagrid" toolbar="#toolbar_product"
                ...
                <tr>
                    ...
                    <th field="BATCHCODE" width="120px"
                        editor="{type:'combobox',options:{'required':true,'icons':[],onBeforeLoad:loadOldBatchCode,url:'<%=basePath %>planner/tbp/batchCode',panelHeight:50,valueField:'v',textField:'t',groupField:'group'}}">
                        批次号
                    </th>
                    ...
                    <th field="DELIVERYCOUNT" width="100px"
                        editor="{type:'numberbox',options:{precision:0,'required':true}}">发货数量(托)
                    </th>
                    <th field="DELIVERYSUITCOUNT" width="100px"
                        editor="{type:'numberbox',options:{precision:0,'required':true}}">发货数量(套)
                    </th>
                    <th field="MEMO" width="120px"
                        editor="{type:'textbox',options:{precision:0}}">备注(kg)
                    </th>
                </tr>
                </thead>
                <thead>
                <tr>
                    ...
                    <th field="CUSTOMERMATERIALCODEOFFP" width="120px"
                        editor="{type:'textbox',options:{precision:0}}">客户物料号
                    </th>
