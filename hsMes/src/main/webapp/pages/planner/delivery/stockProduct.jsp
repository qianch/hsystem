...
<script type="text/javascript">
	...
	function formatterState(value, row) {
 	...
 	var stock = ${empty stock?"[]":stock};
</script>
<div style="border-top:1px solid #DDDDDD">
	客 户：<input type="text" readonly="true" class="easyui-textbox"
		value="${dp.deliveryTargetCompany}"><br> 出货单号：<input
		type="text" readonly="true" class="easyui-textbox"
		value="${dp.deliveryCode}"><br> 装箱序号：<input type="text"
		readonly="true" class="easyui-textbox" value="${dpo.pn}"><br>
</div>
<table id="stock_dg" singleSelect="false" title="" style="width:100%;"
	class="easyui-datagrid" pagination="true" rownumbers="true"
	fitColumns="false" fit="false" remoteSort="true"
