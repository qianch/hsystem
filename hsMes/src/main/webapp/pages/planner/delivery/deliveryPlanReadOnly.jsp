...
<div>
	...
	<form id="deliveryPlanForm" style="margin-bottom: 0px;" method="post"
		...
		<table width="100%">
			<tr>
				...
				</select> <input type="text" id="deliveryCode" readonly="true" style="width: 95%;//宽度 height=20px;//高度"
				...
				<td><input type="text" id="deliveryDate" name="deliveryDate" style="width: 95%;//宽度 height=20px;//高度"
					readonly="true" value="${deliveryPlan.deliveryDate}"
				...
				<td><input type="text" id="packagingType" name="packagingType" style="width: 95%;//宽度 height=20px;//高度"
					readonly="true" value="${deliveryPlan.packagingType}"
			...
			<tr>
				...
				<td width="27%"><input type="text" readonly="true" style="width: 95%;//宽度 height=20px;//高度"
					id="deliveryTargetCompany" name="deliveryTargetCompany"
					value="${deliveryPlan.deliveryTargetCompany}" required="true"
					class="easyui-searchbox" data-options="searcher:selectConsumer" style="width:70%;height:22px;"></td>
		...
		<table width="100%">
			<tr>
				...
				<!--注意事项-->
				<td><textarea id="attention" name="attention" readonly="true"
						style="width:100%;height:70px;" placeholder="1000字以内">${deliveryPlan.attention}</textarea></td>
	...
	<div style="height: 300px;">
		<div style="height: 50%">
			<div id="tb">
				<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search" onclick="searchProduct()">
						查看货物位置
					</a>
			</div>
