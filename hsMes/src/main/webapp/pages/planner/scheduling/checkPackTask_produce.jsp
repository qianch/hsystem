...
<body class="easyui-layout" >
	<div>
		<table id="dg" singleSelect="true"  url="${path}device/scheduling/packTaskList?ppdId=${ppdId}" title="" class="easyui-datagrid" pagination="false" rownumbers="true" fitColumns="true" fit="false" >
			<thead>
				<tr>
