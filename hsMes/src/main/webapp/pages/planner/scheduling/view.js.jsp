...
<script type="text/javascript">
    ...
    const showPrinterList = path + "printer/showPrinterPageList";
    ...
    function doPrintList() {
        const rows = EasyUI.grid.getSelections("dg");
        const ids = [];
        ...
        const dialogId = Dialog.open("打印", 400, 200, showPrinterList + "?ids=" + ids + "&departmentCode=" + rows[0].WORKSHOPCODE, [EasyUI.window.button("icon-ok", "打印", function () {
