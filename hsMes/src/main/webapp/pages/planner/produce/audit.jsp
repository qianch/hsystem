...
<script type="text/javascript">
    ...
    function viewReqDetails() {
        const r = EasyUI.grid.getOnlyOneSelected("produceProducts");
        _innerParam = r;
        const wid1 = Dialog.open("查看", 500, 400, add_req_detailUrl + "?productId=" + r.PRODUCTID, [EasyUI.window.button("icon-cancel", "关闭",
            function () {
                Dialog.close(wid1);
            })], function () {
    ...
    function _loadTask() {
        const row = EasyUI.grid.getOnlyOneSelected("produceProducts");
...
<div style="height:98%">
    ...
    <div id="produceProducts_toolbar">
        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'platform-folder24'"
           onClick="turnBagContent()">翻包领料</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconcls="icon-edit"
           onclick="viewReqDetails()">查看 工艺/包装 需求</a>
        <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'platform-plugin'" onClick="_loadTask()">查看包装任务</a>
    </div>
    <table id="produceProducts" singleSelect="true" class="easyui-datagrid" fitColumns="false" height="300px"
           width="100%" toolbar="#produceProducts_toolbar"
