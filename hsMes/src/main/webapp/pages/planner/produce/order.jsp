  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
		...
		<table width="100%" id="orderProductSelect" idField="ID" toolbar="#produceSalesOrderSearchToolbar" singleSelect="false" title="" class="easyui-datagrid"  
			url="${path}planner/produce/order/list2" 
			fitColumns="false"
			fit="true"
			pagination="true"
	...
	<div id="salesOrderMemo" data-options="region:'east',border:true,split:true" title="销售订单备注" style="width:200px;padding:5px;">
		<table id="partCounts" class="easyui-datagrid" style="width:100%;" fitColumns="true" title="产品部件数量" data-options="rowStyler:danxiangbu">
			<thead>
				<tr>
