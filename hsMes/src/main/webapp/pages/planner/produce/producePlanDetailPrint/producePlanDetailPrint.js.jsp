...
<script>
    var findProducePlanDetailPrintsUrl = path + "planner/producePlanDetail/findProducePlanDetailPrints";
    var selectorPrintBtwFilePrintUrl = path + "selector/selectorBtwFilePrint";
    var editProducePlanDetailPrintsUrl = path + "planner/producePlanDetail/editProducePlanDetailPrints";
    var addPlanPrintsUrl = path + "planner/producePlanDetail/saveProducePlanDetailPrints";
    var createProducePlanDetailPrintsUrl = path + "planner/producePlanDetail/createProducePlanDetailPrints";
    ...
    //编辑销售订单
    var editProducePlanDetailPrints = function () {
        action = "edit";
        var r = EasyUI.grid.getOnlyOneSelected("producePlanDetaildg");
    ...
    function saveForm() {
        ...
        var rows = $("#dg_PlanDetailPrint").datagrid('getRows');//获得所有行
        var planDetailPrintsData = [];
        var producePlanDetailId = $("#producePlanDetailId").val();
        ...
        var postdata = $.param(params);
        //var postdata =	'planDetailPrintsData='+JSON.stringify(planDetailPrintsData)
    ...
    function selectorPrintBtwFile() {
        ...
        selectorPrintBtwFileId = Dialog.open("选择打印标签属性", 900, 500, selectorPrintBtwFilePrintUrl + "?btwFileId=" + $('#btwFileId').val(), [EasyUI.window.button("icon-ok", "选择", function () {
            ...
            var rows = $("#selectorBtwFilePrint_dg").datagrid("getChecked");
    ...
    function removePrintBtwFile() {
        // 获取选中行的Index的值
        var rowIndex = $('#dg_PlanDetailPrint').datagrid('getRowIndex', $('#dg_PlanDetailPrint').datagrid('getSelected'));
