        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="producePlanSearchForm" autoSearch="true" autoSearchFunction="false">
                ...
                <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search"
                   onclick="producePlanDetailfilter()">
                    搜索
                </a>
            </form>
        </div>
        <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconcls="icon-edit"
           onclick="editProducePlanDetailPrints()">修改打印记录
        </a>
    </div>
    <table id="producePlanDetaildg" singleSelect="true" title="" class="easyui-datagrid" toolbar="#toolbar"
