...
<script type="text/javascript">
    let tasks = ${empty packageTask?"[]":packageTask};
    let pid = ${pid};
...
<form id="tray-print-form">
    <table style="width:100%;">
        <tr>
            ...
            <td>
                <ul class="easyui-combotree" required="true" style="width:250px" panelHeight="300px" id="printerTree"
                    data-options="url:'${path }/print/printers',method:'get',animate:true,lines:true"></ul>
            </td>
        </tr>
        <tr>
