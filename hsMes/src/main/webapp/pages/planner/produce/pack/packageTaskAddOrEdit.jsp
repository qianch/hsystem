...
<script type="text/javascript">
    const tasks = ${empty packageTask?"[]":packageTask};
    let pid = ${pid};
    let packCodes = ${empty codes?"[]":codes};
...
<!--包装任务列表表单-->
<table id="pack_task_dg" singleSelect="false" class="easyui-datagrid" toolbar="#pack_task_toolbar" pagination="false"
    ...
    <tr>
        ...
        <th field="PACKBOMID" formatter="codeFormatter" width="550"
            editor="{type:'combobox',options:{icons:[],filter:comboFilter,required:true,data:packCodes,valueField:'PACKAGEBOMID',textField:'PACKAGECODE',editable:true,onHidePanel:validCode,panelHeight:'100'}}">
            包装代码
        </th>
        <th field="TRAYCOUNT" width="60"
            editor="{type:'numberspinner',options:{required:true,min:1,max:9999,precision:0}}">总托数
        </th>
    </tr>
    </thead>
</table>
