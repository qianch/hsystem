...
<div data-options="region:'center',border:false,fit:true" style="height:100%">
    <table id="_view_stock_" singleSelect="false" class="easyui-datagrid"
           url="${path}stock/productStock/viewList1?factoryProductName=${factoryProductName}&productProcessCode=${productProcessCode}&productProcessBomVersion=${productProcessBomVersion}&workShopCode=${workShopCode}"
           toolbar="#toolbar1"
           rownumbers="true" showFooter="true" fitColumns="true" fit="true" remoteSort="false"
           data-options="emptyMsg:'无库存',rowStyler:rowStyler,onLoadSuccess:function(data){if(data.total==0){Tip.warn('无库存');}}">
