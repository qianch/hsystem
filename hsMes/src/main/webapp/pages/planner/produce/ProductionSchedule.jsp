...
<div data-options="region:'center',border:false"
    ...
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <div id="p" class="easyui-panel" title="查询"
                 style="width:100%;height:180px; padding:5px;background:rgb(250, 250, 250);"
                ...
                <form action="#" id="ProductscheFrom" autoSearchFunction="false">
                    　任务单编号:<input type="text" name="filter[plancode]" like="true" class="easyui-textbox"
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <br>
                    客户产品名称:<input type="text" name="filter[consumerproductname]" like="true"
                                        class="easyui-textbox" data-options="onChange:filter">
                    ...
                    　　　批次号:<input type="text" name="filter[batchcode]" like="true" class="easyui-textbox"
                                     data-options="onChange:filter">
                    　　卷长:<input type="text" name="filter[productlength]" like="true" class="easyui-textbox"
                                  data-options="onChange:filter">
                    <br>
                    　　工艺代码:<input type="text" name="filter[processbomcode]" like="true" class="easyui-textbox"
                                      data-options="onChange:filter">
                    工艺版本:<input type="text" name="filter[processbomversion]" like="true" class="easyui-textbox"
                                    data-options="onChange:filter">
                    　　关闭状态:<input type="text" name="filter[closed]" class="easyui-combobox"
                                      data-options="valueField:'v',textField:'t',data:[{'v':'','t':'正常'},{'v':'1','t':'已关闭'}],onSelect:filter">
                    　　门幅:<input type="text" name="filter[productwidth]" like="true" class="easyui-textbox"
                                  data-options="onChange:filter">
                    <br>
                    　　包装代码:<input type="text" name="filter[bcbomcode]" like="true" class="easyui-textbox"
                                      data-options="onChange:filter">
                    包装版本:<input type="text" name="filter[bcbomversion]" like="true" class="easyui-textbox"
                                    data-options="onChange:filter">
                    　出口(内 销):<input type="text" name="filter[salesorderisexport]" class="easyui-combobox"
                                        data-options="valueField:'v',textField:'t',data:[{'v':'1','t':'内销'},{'v':'0','t':'外销'}],onSelect:filter">
                    计划类型:<input type="text" name="filter[isTurnBagPlan]" class="easyui-combobox"
                                    data-options="valueField:'v',textField:'t',data:[{'v':'生产','t':'生产'},{'v':'翻包','t':'翻包'}],onSelect:filter">

                    <br>
                    计调下单时间:<input type="text" style="width:173px;" class="easyui-datebox" id="start"
                                        name="filter[start]" data-options="icons:[]">

                    　　　至:<input type="text" style="width:173px;" class="easyui-datebox" id="end" name="filter[end]"
                                 data-options="icons:[]">

                    　　出货时间:<input type="text" style="width:173px;" class="easyui-datebox" id="sstart"
                                      name="filter[sstart]" data-options="icons:[]">
                    　　　至:<input type="text" style="width:173px;" class="easyui-datebox" id="send" name="filter[send]"
                                 data-options="icons:[]">
                    &nbsp;&nbsp;&nbsp;&nbsp;<br>
                    　　销售人员:<input type="text" name="filter[username_s]" like="true" class="easyui-textbox"
                                      data-options="onChange:filter">
                    计调人员:<input type="text" name="filter[username_p]" like="true" class="easyui-textbox"
                                    data-options="onChange:filter">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生产状态:<input type="text" name="filter[prodStatus]"
                                                                              class="easyui-combobox"
                                                                              data-options="valueField:'v',textField:'t',data:[{'v':'0','t':'未生产'},{'v':'1','t':'生产中'},{'v':'2','t':'已完成'}],onSelect:filter">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机台:<input type="text" name="filter[devicecode]"
                    ...
                    <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-print"
                       onclick="new_window = window.open(); export1();">导出</a>
                </form>
            </div>
        </div>
    </div>
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid"
        ...
        <tr>
            ...
            <th field="SALESORDERISEXPORT" sortable="true" width="90" data-options="formatter:exportFormat">出口(内销)
            </th>
