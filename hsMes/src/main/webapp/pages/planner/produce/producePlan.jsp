...
<div data-options="region:'center',border:false" style="" title="">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="producePlanSearchForm" autoSearch="true" autoSearchFunction="false">
                任务单号：<input type="text" name="filter[condition]" like="true" class="easyui-textbox"
                                style="width:250px;">
    ...
    <table id="dg" singleSelect="true" class="easyui-datagrid" toolbar="#toolbar" pagination="true" rownumbers="true"
        ...
        <tr>
            ...
            <th field="HASCREATEDCUTANDWEAVEPLAN" sortable="true" width="80" formatter="resultFormatter">
                生成编织、裁剪计划
            </th>
