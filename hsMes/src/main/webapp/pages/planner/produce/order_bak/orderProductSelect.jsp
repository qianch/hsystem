...
<div id="produceSalesOrderSearchToolbar">
    <form id="produceSalesOrderForm">
        <input type="text" like="true" class="easyui-searchbox" editable="true" style="width:400px"
               name="filter[condition]" data-options="searcher:reloadProduceOrder" prompt="请输入订单号或者产品型号">
        <input type="hidden" id="_consumerName_salesOrder_detail" name="filter[consumerName]" value="">
    </form>
</div>
<table width="100%" id="orderProductSelect" idField="ID" toolbar="#produceSalesOrderSearchToolbar" singleSelect="false"
       title="" class="easyui-datagrid" url="${path}planner/produce/order/list?all=1" fitColumns="false" fit="true"
       data-options="
