  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="overflow: false;position: relative; height: 140px; width: 925px">
		...
		<table id="dg" idField="ID" singleSelect="true" title="销售订单列表" class="easyui-datagrid"  url="${path}salesOrder/list?all=1&filter[auditState]=2&filter[isClosed]=0" toolbar="#toolbar" pagination="false"  data-options="onDblClickRow:dbClickEdit,rowStyler:rowStyler,onClickRow:orderRowClick " >
			<thead>
				<tr>
					...
					<th field="SALESORDERISEXPORT" sortable="true" width="65" data-options="formatter:exportFormat">内销/外销</th>
