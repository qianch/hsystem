...
<div>
    <!--裁剪计划表单-->
    <form id="cutPlanForm" method="post" ajax="true" action="<%=basePath %>cutPlan/${empty cutPlan.id ?'add':'edit'}"
          autocomplete="off">
        ...
        <table width="100%">
            <tr>
                ...
                <!--订单号-->
                <td><input type="text" id="partName" data-options="'icons':[],width:'90%'" name="partName"
                           value="${tcVersionParts.tcProcBomVersionPartsName}" class="easyui-textbox" editable="false">
                </td>
            </tr>
            <tr>
                <td class="title">人员姓名:</td>
                <!--人员姓名-->
                <td><input type="text" id="userName" class="easyui-searchbox" required="true"
