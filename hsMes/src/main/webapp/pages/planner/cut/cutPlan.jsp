...
<%--		                        {value:'00109',text:'编织三车间'}],onchange:loadProducePlans()"><br/>--%>
	                <input id="searchInput0" name="searchInput" type="text" class="easyui-searchbox" prompt="输入计划单号" searcher="loadProducePlans" editable="true"
					...
					<input id="searchInput3"name="searchInput3"type="text"  class="easyui-searchbox" prompt="输入批号"searcher="loadProducePlans" editable="true"data-options="icons:[{iconCls:'icon-clear',handler:function(e){$(e.data.target).searchbox('clear');loadProducePlans();}}]"><br/>
					<input id="searchInput4"name="searchInput4"type="text"  class="easyui-searchbox" prompt="输入订单号"searcher="loadProducePlans" editable="true"data-options="icons:[{iconCls:'icon-clear',handler:function(e){$(e.data.target).searchbox('clear');loadProducePlans();}}]">
				</form>
			</div>
	...
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
		...
		<table id="dg" singleSelect="true" title="计划列表" class="easyui-datagrid"  toolbar="#toolbar" pagination="false" rownumbers="true" fitColumns="false" fit="true" data-options="">
			<thead>
				<tr>
	...
	<div id="dlg" class="easyui-dialog" title="创建裁剪任务单" style="width:600px;height:200px;"
            ...
            <form id="cutTaskForm" method="post" ajax="true" action="<%=basePath %>cutTask/${empty cutTask.id ?'add':'edit'}" autocomplete="off" autoSearchFunction="false">
				...
				<input type="hidden" id="createTime" name="createTime" value="<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />">
				...
				<table width="100%">
						<tr>
							...
							<!--发货日期-->
							<td>
								<input type="text" id="deliveryDate" name="deliveryDate" class="easyui-textbox" data-options="icons:[]" editable="false" required="true" >
							</td>
						</tr>
						<tr>
							...
							<!--订单号-->
							<td>
								<input type="text" id="orderCode" name="orderCode" class="easyui-textbox" data-options="icons:[]" editable="false" required="true" >
							</td>
							<td class="title">批次号:</td>
							<!--批次号-->
							<td>
								<input type="text" id="batchCode" name="batchCode" class="easyui-textbox" data-options="icons:[]" editable="false" required="true" >
							</td>
						</tr>
						<tr>
							...
							<!--客户简称-->
							<td>
								<input type="text" id="consumerSimpleName" name="consumerSimpleName" class="easyui-textbox" data-options="icons:[]" editable="false" required="true" >
							</td>
						...
						<tr>
							...
							<!--部件名称-->
							<td>
								<input type="text" id="partName" name="partName" class="easyui-textbox" data-options="icons:[]" editable="false" required="true" >
							</td>
							<td class="title">任务单套数:</td>
							<!--任务单套数-->
							<td>
								<input type="text" id="suitCount" name="suitCount" class="easyui-textbox" data-options="icons:[]" editable="false" required="true" >
							</td>
						</tr>
