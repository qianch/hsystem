...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="true" title="计划列表" class="easyui-datagrid" url="" toolbar="#toolbar"
           pagination="false" rownumbers="true" fitColumns="false" fit="true"
           data-options="
...
<div id="dlg" class="easyui-dialog" title="创建裁剪任务单" style="width:600px;height:200px;"
    ...
    <form id="cutTaskForm" method="post" ajax="true" action="<%=basePath %>cutTask/${empty cutTask.id ?'add':'edit'}"
        ...
        <input type="hidden" id="taskCreateTime" name="taskCreateTime"
        ...
        <table width="100%">
            <tr>
                ...
                <!--发货日期-->
                <td>
                    <input type="text" id="taskDeliveryDate" name="taskDeliveryDate" class="easyui-textbox"
            ...
            <tr>
                ...
                <!--订单号-->
                <td>
                    <input type="text" id="taskOrderCode" name="taskOrderCode" class="easyui-textbox"
                           data-options="icons:[]" editable="false" required="true">
                </td>
                <td class="title">批次号:</td>
                <!--批次号-->
                <td>
                    <input type="text" id="taskOrderBatchCode" name="taskOrderBatchCode" class="easyui-textbox"
                           data-options="icons:[]" editable="false" required="true">
                </td>
            </tr>
            <tr>
                ...
                <!--客户简称-->
                <td>
                    <input type="text" id="taskConsumerSimpleName" name="taskConsumerSimpleName" class="easyui-textbox"
                           data-options="icons:[]" editable="false" required="true">
                </td>
            ...
            <tr>
                ...
                <!--部件名称-->
                <td>
                    <input type="text" id="taskPartName" name="taskPartName" class="easyui-textbox"
                           data-options="icons:[]" editable="false" required="true">
                </td>
                <td class="title">任务单套数:</td>
                <!--任务单套数-->
                <td>
                    <input type="text" id="taskSuitCount" name="taskSuitCount" class="easyui-textbox"
                           data-options="icons:[]" editable="false" required="true">
                </td>
            </tr>
        </table>
