	...
	<form id="finishProductForm" method="post" ajax="true"
		...
		<table width="100%">
			...
			<tr>
				...
				<td>
					<label for="productIsTc3"><input id="productIsTc3" type="radio" value="-1"  name="productIsTc" checked="checked">
					胚布</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="padding-left:10px"><textarea id="productMemo"
						name="productMemo" readonly="true" style="width:90%;height:100px;">${finishProduct.productMemo}</textarea></td>
			</tr>
			<tr>
				<td class="title">包装要求:</td>
				<!--备注-->
				<td style="padding-left:10px"><textarea id="packReq"
						name="packReq" style="width:90%;height:100px;" maxlength="500" readonly="true" placeholder="限500字以内">${finishProduct.packReq}</textarea></td>
				<td class="title">工艺要求:</td>
				<!--备注-->
				<td style="padding-left:10px"><textarea id="procReq"
						name="procReq" style="width:90%;height:100px;" maxlength="500" readonly="true" placeholder="限500字以内">${finishProduct.procReq}</textarea></td>
			</tr>
		</table>
	</form>
</div>