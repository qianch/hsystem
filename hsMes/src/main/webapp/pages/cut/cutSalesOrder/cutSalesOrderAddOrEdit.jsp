    ...
    <form id="cutSalesOrderForm" method="post" ajax="true" autocomplete="off">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text"
                           ...
                           value="${cutSalesOrder.batchCode}" class="easyui-searchbox"
                           required="true" data-options="searcher:chooseproducePlanDetail,icons:[]">
                ...
                <!--订单名称-->
                <td>
                    <input type="text" id="salesOrderCode" name="salesOrderCode" value="${cutSalesOrder.salesOrderCode}" readonly="true"
            ...
            <tr>
                ...
                <!--订单代码-->
                <td>
                    <input type="number"    id="orderNum" name="orderNum" value="${cutSalesOrder.orderNum}" class="easyui-textbox">
