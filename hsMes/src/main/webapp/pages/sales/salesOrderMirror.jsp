...
<div region="west" split="true" title="产品层级结构" style="width:450px;">
    <div class="easyui-layout" fit=true>
        <div data-options="region:'north',split:false,border:false" class="datagrid-toolbar" style="height:52px;text-align: center;">
            <input id="searchInput" type="text" class="easyui-searchbox" prompt="请输入订单编号" searcher="searchInfo" editable="true" data-options="width:'90%',icons:[{iconCls:'icon-clear',handler:function(e){$(e.data.target).searchbox('clear');}}]">
        </div>
...
<div data-options="region:'center',border:false">
    <div style="height:33%">
        <table singleSelect="false" fit="true" id="dg" title="非套材BOM镜像明细列表"
               style="width:auto;" class="easyui-datagrid" url="" pagination="true" rownumbers="true" fitColumns="true" showFooter="true">
            <thead>
            <tr>
                <th field="ID" checkbox=true></th>
                <th field="FTCBOMDETAILNAME" sortable="true" width="12" data-options="editor:{type:'textbox',options:{required:true,validType:'length[1,30]'}}">编织结构</th>
                <th field="FTCBOMDETAILMODEL" sortable="true" width="12"
					...
					">原料规格</th>
                <th field="FTCBOMDETAILITEMNUMBER" sortable="true" width="12" data-options="editor:{type:'textbox',options:{validType:'length[1,30]'}}">物料代码</th>
                <th field="FTCBOMDETAILWEIGHTPERSQUAREMETRE" sortable="true" width="10" data-options="editor:{type:'numberbox',options:{required:true,precision:2}}">单位面积质量(g/m²)</th>
                <th field="FTCBOMDETAILREED" sortable="true" width="12" data-options="editor:{type:'textbox',options:{validType:'length[1,30]'}}">钢筘规格</th>
                <th field="FTCBOMDETAILGUIDENEEDLE" sortable="true" width="12" data-options="editor:{type:'textbox',options:{validType:'length[1,30]'}}">导纱针规格</th>
                <th field="FTCBOMDETAILREMARK" sortable="true" width="12" data-options="editor:{type:'textbox',options:{validType:'length[1,30]'}}">备注</th>
    ...
    <div style="height:33%;">
        <div class="easyui-tabs" fit="true" >
            <div title="部件镜像明细列表">
                <table singleSelect="true" fit="true" id="partsDetails" remoteSort="false" fitColumns="true" pagination="true" style="width:100%;" class="easyui-datagrid" url="" rownumbers="true" fitColumns="true">
                    <thead>
                    <tr>
            ...
            <div title="部件成品重量胚布镜像信息">
                <table singleSelect="true" fit="true" id="partsFinishedWeightEmbryoCloth" remoteSort="false" fitColumns="true" pagination="true" style="width:100%;" class="easyui-datagrid" url="" rownumbers="true" fitColumns="true">
                    <thead>
                    <tr>
                        <th field="ID" checkbox=true ></th>
    ...
    <div style="height:33%">
        <div class="easyui-tabs" fit="true" >
            <div title="版本部件镜像列表">
                <table singleSelect="true" fit="true" id="parts" pagination="true"  class="easyui-datagrid" url="" rownumbers="true" fitColumns="false">
            <thead>
            <tr>
                <th field="ID" checkbox=true></th>
                ...
                <th field="CUSTOMERMATERIALCODE" sortable="true" width="100" data-options="editor:{type:'textbox',options:{required:true}}">客户物料号</th>
            ...
            <div title="成品信息列表">
                ...
                <table singleSelect="true" fit="true" id="product" pagination="true"  class="easyui-datagrid" url="" rownumbers="true" fitColumns="false">
                    <thead frozen="true">
                    <tr>
                        <th field="I" checkbox=true ></th>
