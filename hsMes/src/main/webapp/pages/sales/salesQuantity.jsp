		...
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="salesQuantityFrom" autoSearchFunction="false">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;至 &nbsp;&nbsp;&nbsp;&nbsp;
					<input type="text" style="width:173px;" class="easyui-datebox" id="end" name="filter[end]" data-options="icons:[]">
					出货时间 :<input type="text" style="width:173px;" class="easyui-datebox" id="start2" name="filter[start2]" data-options="icons:[]">
					&nbsp;&nbsp;至 &nbsp;&nbsp;
					<input type="text" style="width:173px;" class="easyui-datebox" id="end2" name="filter[end2]" data-options="icons:[]">
					&nbsp;&nbsp;&nbsp;&nbsp;
