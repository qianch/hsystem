		...
		<div id="toolbar">
			...
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="salesOrderSearchForm" autoSearchFunction="false">
					...
					订单属性:<input type="text" name="filter[export]"class="easyui-combobox"   data-options="valueField:'v',textField:'t',data:[{'v':'1','t':'内销'},{'v':'0','t':'外销'}],onSelect:filter">
					<br>
					厂内名称:<input type="text" name="filter[factoryProductName]" like="true" class="easyui-textbox" data-options="onChange:filter">
					客户产品:<input type="text" name="filter[consumerProductName]" like="true" class="easyui-textbox" data-options="onChange:filter">
					产品规格:<input type="text" name="filter[productModel]" like="true" class="easyui-textbox" data-options="onChange:filter">
				</form>
			</div>
		</div>
		<table id="dg" singleSelect="true" title="" url="${path}salesOrder/list"  toolbar="#toolbar" pagination="true"  data-options="onClickRow:orderRowClick,nowrap:false,onLoadSuccess:onDgLoadSuccess " >
			<thead>
				<tr>
					...
					<th field="SALESORDERISEXPORT" sortable="true" width="10" data-options="formatter:exportFormat">内销/外销/胚布</th>
