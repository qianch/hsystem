...
<div data-options="region:'center',border:false"
    ...
    <table id="dg" singleSelect="false" title="" url="${path}consumer/list" , class="easyui-datagrid" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="false" fit="true"
           data-options="onDblClickRow:dbClickEdit,onLoadSuccess:dgLoadSuccess,remoteFilter:true">
        <thead frozen="true">
        <tr>
