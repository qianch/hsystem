...
<div data-options="region:'center',border:false">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="salesOrderSearchForm" autoSearchFunction="false">
                ...
                批次号　:<input type="text" name="filter[productBatchCode]" like="true" class="easyui-textbox"
                               data-options="onChange:filter"><br>
                客户名称:<input type="text" name="filter[consumerProductName]" like="true" class="easyui-textbox"
                                data-options="onChange:filter">
    ...
    <table id="dg" singleSelect="true" title="" url="${path}salesOrder/listcalico" toolbar="#toolbar" pagination="true"
        ...
        <tr>
            ...
            <th field="SALESORDERISEXPORT" hidden="true" sortable="true" width="10"
                data-options="formatter:exportFormat">内销/外销/胚布
            </th>
