...
<html>
  <head>
	...
	<%@ include file="calicoOrder.js.jsp" %>
	<style type="text/css">
		@keyframes changed {
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false">
		<div id="toolbar">
			...
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="salesOrderSearchForm" autoSearchFunction="false">
					订单编号:<input type="text" name="filter[orderCode]" like="true" class="easyui-textbox" data-options="onChange:filter">
					客户名称:<input type="text" name="filter[consumerName]" like="true" class="easyui-textbox">
					订单号　:<input type="text" name="filter[salesOrderSubCode]" like="true" class="easyui-textbox" data-options="onChange:filter">
					...
					订单类型:<input type="text" name="filter[orderType]"class="easyui-combobox" data-options="valueField:'v',textField:'t',data:[{'v':'1','t':'常规'},{'v':'2','t':'试样'},{'v':'3','t':'新品'},{'v':'-1','t':'未知'}],onSelect:filter">
					批次号　:<input type="text" name="filter[productBatchCode]" like="true" class="easyui-textbox" data-options="onChange:filter">
					<br>
					客户名称:<input type="text" name="filter[consumerProductName]" like="true" class="easyui-textbox" data-options="onChange:filter">
					产品规格:<input type="text" name="filter[productModel]" like="true" class="easyui-textbox" data-options="onChange:filter">
					厂内名称:<input type="text" name="filter[factoryProductName]" like="true" class="easyui-textbox" data-options="onChange:filter">
					
				</form>
			</div>
		</div>
		<table id="dg" singleSelect="true" title="" url="${path}salesOrder/listcalico" toolbar="#toolbar" pagination="true"  data-options="onClickRow:orderRowClick,nowrap:false,onLoadSuccess:onDgLoadSuccess " >
			<thead>
				<tr>
					...
					<th field="DELIVERYTIME" sortable="true" width="13" data-options="formatter:orderPlaceFormat">发货日期</th>
					<th field="CONSUMERNAME" hidden="true" sortable="true" width="35">客户名称</th>
					<th field="SALESORDERISEXPORT" hidden="true" sortable="true" width="10" data-options="formatter:exportFormat">内销/外销/胚布</th>
	 ...
	 <div id="salesOrderMemo" data-options="region:'east',border:true,split:true" title="销售订单备注" style="width:200px;padding:5px;">
