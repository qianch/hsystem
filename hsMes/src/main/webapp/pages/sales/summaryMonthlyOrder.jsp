...
<div data-options="region:'center',border:false"
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="summaryMonthlyOrderFrom" autoSearchFunction="false">
                ...
                至<input type="text" style="width:173px;" class="easyui-datebox" id="end" name="filter[end]"
                         data-options="icons:[]">
                &nbsp;&nbsp;出货时间:
                <input type="text" style="width:173px;" class="easyui-datebox" id="outstart" name="filter[outstart]"
                       data-options="icons:[]">
                至<input type="text" style="width:173px;" class="easyui-datebox" id="outend" name="filter[outend]"
                         data-options="icons:[]">
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid"
        ...
        <thead>
        <tr>
            <th field="PLANTOTALWEIGHT" sortable="true" width="120" formatter="plantotalweightFormatter">
                计调下单量(kg)
            </th>
