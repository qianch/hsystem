...
<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="scheduleLogSearchForm" autoSearchFunction="false">
                任务名称：<input type="text" name="filter[taskName]" id="taskName" like="true" value="" class="textbox"
                                style="height:22px;">
                运行结果:<input type="text" name="filter[executeResult]" id="executeResult" class="easyui-combobox"
                                data-options="valueField:'v',textField:'t',data:[{'v':'0','t':'成功'},{'v':'1','t':'失败'}],onSelect:filter">
                起始时间：<input type="text" name="filter[startexecuteTime]" id="startexecuteTime" value=""
                                readonly="readonly" class="textbox laydate-icon">
                结束时间：<input type="text" name="filter[endexecuteTime]" id="endexecuteTime" value=""
                                readonly="readonly" class="textbox laydate-icon">
    ...
    <table id="dg" singleSelect="false" class="easyui-datagrid" nowrap="false" url="${path}scheduleLog/list"
           toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true" data-options="">
        <thead>
        <tr>
