...
<script type="text/javascript">
	...
	function doChange(act){
		...
		if(act===-1){
			...
			$("#productPackageVersion").searchbox({"required":true});
	...
	$(function(){
		var productRollWeight = $("#productRollWeight").val();
		var maxWeight = $("#maxWeight").val();
		var minWeight = $("#minWeight").val();
		if((productRollWeight==null || productRollWeight=="") && (maxWeight==null || maxWeight=="") && (minWeight==null || minWeight=="") ){
			$("#isShowWeight").hide();
		}
	})
</script>
		...
		<table width="100%">
			<tr>
				...
				<td><input id="productConsumerName" class="easyui-textbox" readOnly="true"
					value="${consumer.consumerName}"  required="true" style="width:360px"></td>

				<td class="title">客户代码:</td>
				<!--客户代码-->
				<td><input id="productConsumerCode" class="easyui-textbox" readonly="true" readOnly="true"
					value="${consumer.consumerCode}" editable="false" style="width:360px"></td>
			</tr>
			<tr>
				...
				<td><input type="text" id="consumerProductName"
					...
					required="true" data-options="validType:['length[0,150]']" style="width:360px"></td>
				...
				<td><input type="text" id="factoryProductName"
					...
					data-options="validType:['length[0,150]']" style="width:360px"></td>
			</tr>
			<tr>
				...
				<td><input type="text" id="productWidth" name="productWidth"readOnly="true"
					...
					suffix="mm" precision="2" style="width:360px"></td>
				...
				<td><input type="text" id="productRollLength"readOnly="true"
					...
					class="easyui-numberbox" suffix="m" precision="2" style="width:360px"></td>
			</tr>
			<tr>
				...
				<td><input type="text" id="customerMaterialCodeOfFP"readOnly="true"
						   ...
						   class="easyui-textbox" suffix="m" precision="2" style="width:360px"></td>
			</tr>
			<tr>
				...
				<td><input type="text" id="productRollWeight"readOnly="true"
					...
					class="easyui-numberbox" suffix="Kg" precision="1" style="width:360px"></td>
			...
			<tr id="isShowWeight">
				...
				<!--最大卷重-->
				<td><input type="text" id="maxWeight" readOnly="true"
					name="maxWeight" value="${finishProduct.maxWeight}"
					class="easyui-numberbox" suffix="Kg" precision="2" style="width:360px"  ></td>

				<td class="title">最小卷重(kg):</td>
				<!--最小卷重-->
				<td><input type="text" id="minWeight" readOnly="true"
					name="minWeight" value="${finishProduct.minWeight}"
					class="easyui-numberbox" suffix="Kg" precision="2" style="width:360px"  ></td>
			</tr>
			...
			<tr>
				...
				<!--最大卷重-->
				<td><input type="text" id="rollGrossWeight" readOnly="true"
						   name="rollGrossWeight" value="${finishProduct.rollGrossWeight}"
						   class="easyui-numberbox" suffix="Kg" precision="2" style="width:360px"  ></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" id="productProcessName" name="productProcessName"
					value="${finishProduct.productProcessName}" class="easyui-textbox"
					 data-options="validType:['length[0,150]']" style="width:360px" readonly="true" ></td>
				...
				<td><input type="text" id="productShelfLife"readOnly="true"
					...
					class="easyui-numberbox" required="true"  validType="length[1,5]" min="1" precision="0" style="width:360px"></td>	
			...
			<tr>
				...
				<td><input id="productProcessBom" name="productProcessCode"
					...
					class="easyui-searchbox" editable="false" required="true" style="width:360px"></td>
			...
			<tr>
				...
				<!--载具编码-->
				<td>
					<input type="text" id="carrierCode" name="carrierCode" value="${finishProduct.carrierCode}"  class="easyui-combobox" readOnly="true" }
					data-options="icons:[],filter:comboFilter,required:false,data:codes,valueField:'v',textField:'t',editable:true,onHidePanel:validCode,panelHeight:'auto'"  >
				</td>
				<td class="title">成品类别代码：</td>
				<!--成品类别代码-->
				<td>
					<input type="text" id="pcType" name="categoryName" value="${productCategory.categoryCode}"  class="easyui-textbox" editable="false"  style="width:360px" />
				</td>
			</tr>
			<tr>
				<td class="title">成品类别名称：</td>
				<td>
					<input type="text" id="pcCode" name="categoryCode" value="${productCategory.categoryName}" class="easyui-textbox" style="width:360px" readonly="readonly">
				</td>
				<td class="title">物料编码：</td>
				<td>
					<input type="text" id="materielCode" name="materielCode" value="${finishProduct.materielCode}" class="easyui-textbox" style="width:360px" readonly="readonly">
				</td>
			</tr>
			<tr>
				...
				<td><input type="text" id="productModel" name="productModel"
					...
					required="true" data-options="validType:['length[0,150]']" style="width:360px" readonly="true"></td>
			...
			<tr>
				...
				<td>
					<label for="productWeigh0" ><input id="productWeigh0" type="radio" value="0"  disabled name="productWeigh" onclick="Change(0)" ${finishProduct.productWeigh eq 0 || finishProduct.productWeigh eq null ?'checked':''} readOnly="true">
					全称 (单卷重量300KG以上)</label></br>
					<label for="productWeigh1"><input id="productWeigh1" type="radio" value="1"   disabled name="productWeigh" onclick="Change(1)" ${finishProduct.productWeigh eq 1 ?'checked':''} readOnly="true">
					抽称 (单卷重量300KG以下)</label></br>
					<label for="productWeigh2"><input id="productWeigh2" type="radio" value="2"  disabled name="productWeigh" onclick="Change(2)" ${finishProduct.productWeigh eq 2 ?'checked':''} readOnly="true">
					不称 (套裁、坯布)</label>
