...
<script>
    ...
    function view() {
        const r = EasyUI.grid.getOnlyOneSelected("dg_ins");
        const dialogId = Dialog.open("查看审核状态", 700, 400, path + "audit/" + r.AUDITCODE + "/" + r.FORMID + "/state", [EasyUI.window.button("icon-cancel", "关闭", function () {
