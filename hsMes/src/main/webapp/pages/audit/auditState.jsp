...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div id="_audit_state_page_" class="easyui-tabs" style="width:700px;height:250px" fit="true"
         data-options="selected:${fn:length(audit)-1 }">
