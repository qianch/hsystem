...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'east',title:'执行审批',split:true,iconCls:'platform-ok3',minWidth:250,maxWidth:400"
         style="width:250px;">
        ...
        <div id="msgBox" style="text-align: center;padding:3px;">
            <textarea style="width: 100%; height: 200px; resize: none; border: 1px solid #bfbfbf;" id="auditMsg"
                      placeholder="审批意见（1000字以内）" maxLength="1000"></textarea>
        </div>
    ...
    <div data-options="region:'center',title:'审核内容',iconCls:'icon-tip'">
        <iframe scrolling="auto" frameborder="0" src="<%=basePath %>${audit.formUrl}"
...
<script type="text/javascript">
    ...
    let level =;
    let isCompleted =;
    const levelOneResult = "${audit.firstAuditResult}";
    const levelTwoResult = "${audit.secondAuditResult}";
    let levelOneResultText, levelTwoResultText;
    if (levelOneResult === "-1") {
