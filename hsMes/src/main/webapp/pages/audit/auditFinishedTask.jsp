...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="false" class="easyui-datagrid" url="${path}audit/task/finished" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="true" fit="true"
           data-options="onLoadSuccess:loadSuccess,onDblClickRow:dbClickEdit">
        <thead>
        <tr>
