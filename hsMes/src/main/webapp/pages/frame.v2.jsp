        ...
        <div title="首页" style="padding:5px;" iconCls="platform-home">
            ...
            <div id="tab" class="easyui-tabs" style="height:200px;margin:5px">
                <div title="审批消息提醒" style="padding:5px;">
                    <table id="auditDg" singleSelect="true" class="easyui-datagrid" pagination="false" fitColumns="true"
                           fit="true" style="width:100%;" data-options="onClickRow:auditRowClick">
                        <thead>
                        <tr>
