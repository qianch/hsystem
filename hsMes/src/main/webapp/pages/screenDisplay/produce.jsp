  ...
  <head>
    <title>设备机台显示</title>
  	...
  	<style type="text/css">
  		...
  		span{display:inline-block;zoom:1;color:red;}
  		table tr td{font-size:30px;padding:4px;}
  		thead tr td span{margin-left:33px;font-size:30px}
  		thead tr td{font-size:25px}
		thead tr th{font-size:25px}
		tr{height:35px}
		.tip_bar{float:left}
		.graph{
			position:relative;
   ...
   <body>
		...
		<div id="toolbar" class="datagrid-toolbar">
			...
			<input type="text" panelHeight="auto" id="ip" editable="false" class="easyui-combobox"
				style="width:250px;height:25px" data-options="onChange:doChange" url="${path}screen/combobox?all=1" valueField="id" textField="text" value="请选择机台屏幕">
		</div>
		<table id="deviceShow">
			<thead>
				<tr>
