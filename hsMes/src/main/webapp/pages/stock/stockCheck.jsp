...
<div data-options="region:'center',border:false"
    ...
    <table id="dg" singleSelect="false" title="盘库记录表列表" class="easyui-datagrid"
           url="${path}stock/stockCheck/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true"
           fit="true">
        <thead>
        <tr>
