            ...
            <div style="border-top:1px solid #DDDDDD">
                ...
                　操作人：<input type="text" name="filter[optUser]" like="true" class="easyui-textbox">
                    ...
                    入库时间：<input type="text" name="filter[start]"  class="easyui-datetimebox" >
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <input type="text" name="filter[end]" class="easyui-datetimebox">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-excel" onclick="exportDetail2()">
						导出2
					</a>		
                </form>
            </div>
