  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
			...
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="materialSearchForm" autoSearchFunction="false">
					...
					规格型号：<input type="text" name="filter[materialModel]" like="true" class="easyui-textbox"><br>
				        　　仓库：<input type="text" name="filter[warehouseCode]"  class="easyui-combobox"data-options="valueField:'warehouseCode',textField:'warehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=ycl',onSelect:filter"> 
		...
		<table id="dg" singleSelect="false" title="" class="easyui-datagrid"  url="${path}/material/forceOut/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="false" fit="true" >
			<thead>
				<tr>
