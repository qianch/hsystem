...
<script>
//添加盘库记录表
var addUrl=path+"stockCheck/add";
//编辑盘库记录表
var editUrl=path+"stockCheck/edit";
//删除盘库记录表
var deleteUrl=path+"stockCheck/delete";
    ...
    $('#dg').datagrid({
        ...
        onExpandRow: function(index,row){
            ...
            ddv.datagrid({
                ...
                columns:[[
                    {field:'BARCODE',title:'条码号(产品或原料)',width:15,formatter:function(value,row,index){
