...
<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="materialForceOutRecordSearchForm" autoSearchFunction="false">
                ...
                至:&nbsp;<input type="text" id="produceEnd" name="filter[produceEnd]" value=""
                                class="easyui-datetimebox">
                出库时间:<input type="text" id="outStart" name="filter[outStart]" value="" class="easyui-datetimebox">
                至:&nbsp;<input type="text" id="outEnd" name="filter[outEnd]" value="" class="easyui-datetimebox">
                <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-excel"
                   onclick="exportMaterialForceOutRecord()">导出
                </a></br>
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" url="${path}materialForceOutRecord/list"
