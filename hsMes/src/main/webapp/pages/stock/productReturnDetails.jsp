...
<head>
    ...
    <%@ include file="productReturnDetails.js.jsp" %>
</head>
...
<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="productReturnDetailSearchForm" autoSearchFunction="false">
                仓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库:
                <input type="text" class="easyui-combobox" name="filter[newWarehouseCode]" like="true"
                ...
                库&nbsp;&nbsp;&nbsp;&nbsp;位:
                <input type="text" name="filter[newWarehousePosCode]" like="true" class="easyui-textbox">
                条&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:
                <input type="text" name="filter[code]" like="true" class="easyui-textbox">
                <%--	出库车间:<input type="text" name="filter[outAddress]" like="true"
                ...
                客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户:
                <input type="text" name="filter[consumer]" like="true" class="easyui-textbox">
                ...
                回库时间:<input type="text" name="filter[start]" class="easyui-datetimebox">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;至:
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" toolbar="#toolbar" pagination="true"
        ...
        <tr>
            ...
            <th field="NEWWAREHOUSEPOSCODE" sortable="true" width="10%">库位</th>
            <%--<th field="OUTADDRESS" sortable="true" width="10%">出库地址</th>--%>
            <th field="USERNAME" sortable="true" width="10%">回库人</th>
            <th field="INTIME" sortable="true" width="15%">回库时间</th>
        </tr>
        </thead>
    </table>
</div>
