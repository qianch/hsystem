		...
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="productReturnDetailSearchForm" autoSearchFunction="false">
					仓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库:<input type="text" class="easyui-combobox" name="filter[newWarehouseCode]"like="true"
				data-options="valueField:'warehouseCode',textField:'warehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=cp',onSelect:filter">
					库&nbsp;&nbsp;&nbsp;&nbsp;位:<input type="text" name="filter[newWarehousePosCode]" like="true" class="easyui-textbox">
