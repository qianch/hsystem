...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="false" title="成品库存表列表" class="easyui-datagrid"
           url="${path}stock/productStock/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true"
