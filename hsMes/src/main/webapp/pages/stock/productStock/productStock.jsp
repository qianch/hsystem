...
<div data-options="region:'center',border:false"
    ...
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="productStockSearchForm" autoSearchFunction="false">
                终点仓库：<input type="text" class="easyui-combobox" name="filter[warehouseCode]" panelHeight="250"
                                data-options="valueField:'v',textField:'t',method:'get',url:'<%=basePath%>warehouse/queryWarehousebyType?waretype=cpdrk,cpbdk,cpwk'">
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid" toolbar="#toolbar"
        ...
        <tr>
            ...
            <th field="WARETYPE" width="80"
                data-options="formatter:function(value,row,index){return dictFormatter('WareType',value)}">仓库类型
            </th>
