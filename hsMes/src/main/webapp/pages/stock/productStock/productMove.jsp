		...
		<form id="DeliveryOnTheWayPlanForm" method="post" ajax="true"  autocomplete="off">
			...
			<table width="100%">
				<tr>
					...
					<!--出库调拨单号-->
					<td>
						<input type="text" id="deliveryCode" name="deliveryCode" value="${deliveryOnTheWayPlan.deliveryCode}" class="easyui-textbox" readonly="readonly" required="true">
					</td>

					<td class="title">终点仓库:</td>
					<!--终点仓库-->
					<td>
						<input type="text" id="wareHoseCode" name="wareHoseCode" value="${deliveryOnTheWayPlan.wareHouseCode}" class="easyui-textbox" readonly="readonly" required="true">
					</td>
				</tr>
				<tr>
					...
					<!--车牌-->
					<td>
						<input type="text" id="plate" name="plate" value="${deliveryOnTheWayPlan.plate}" class="easyui-textbox" readonly="readonly" required="true">
					</td>
				</tr>
				...
				<tr>
					...
					<!--货运-->
					<td>
						<input type="text" id="warehousePosCode"   class="easyui-searchbox" required="true" data-options="searcher:selectWareHousePos,icons:[]">
	...
	<div data-options="region:'center',title:'条码明细'">
		<div id="toolbar_product">
			<c:if test="${empty force }">
				<a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconcls="icon-add" onclick="selectOnTheWayDetail()">增加</a>
				<a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconcls="icon-remove" onclick="removeOnTheWayDetail()">删除</a>
			</c:if>
		</div>
		<table id="pmoveOnTheWayDetail_dg" singleSelect="true" class="easyui-datagrid" fitColumns="true" style="width:100%;height:100%;" toolbar="#toolbar_product" >
			<thead>
