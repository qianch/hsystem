...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="productInRecordSearchForm" autoSearchFunction="false">
                仓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库:<input type="text" class="easyui-combobox"
                                                                name="filter[warehouseCode]" like="true"
                ...
                条&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:<input type="text" name="filter[code]" like="true"
                                                                      class="easyui-textbox">
                ...
                客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户:<input type="text" name="filter[consumer]" like="true"
                                                                      class="easyui-textbox">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;至:<input type="text" name="filter[end]"
    ...
    <table id="dg" singleSelect="false" showFooter="true" title="" class="easyui-datagrid" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="true" fit="true" data-options="onLoadSuccess:onLoadSuccess">
        <thead frozen="true">
        <tr>
