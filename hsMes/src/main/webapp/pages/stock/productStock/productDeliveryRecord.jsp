   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="overflow: false;position: relative; height: 140px; width: 925px">
		<div id="toolbar">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-rar" onclick="exportMyfd()">
				导出明阳风电出库码单
			</a>
			<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-rar" onclick="exportExcelnew()">导出出库单竖排</a>
			<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-rar" onclick="exportExcelnew1()">导出出库单横排</a>
			<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-rar" onclick="exportExcelnew2()">导出出库单横排2</a>
		</div>
