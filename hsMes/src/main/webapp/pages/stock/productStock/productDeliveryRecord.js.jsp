...
<script>
var findOutRecordUrl = path + "stock/productDeliveryRecord/findOutRecord";

//导出竖排
var exportUrlnew = path + "planner/deliveryPlan/exportnew";
//导出横竖排
var exportUrlnew1 = path + "planner/deliveryPlan/exportnew1";
//导出横竖排2
var exportUrlnew2 = path + "planner/deliveryPlan/exportnew2";
//查询
function filter() {
...
var exportUrl1 = path + "/planner/deliveryPlan/export1";
function export1(){
...
var exportUrl2 = path + "/planner/deliveryPlan/export2";
function export2(){
	var r = EasyUI.grid.getSelections("dg");
	if (r.length == 0) {
		Tip.warn("<spring:message code="Tip.SelectAtLeastOne" />");
...
var exportUrl3 = path + "/planner/deliveryPlan/export3";
function export3(){
	var r = EasyUI.grid.getSelections("dg");
	if (r.length == 0) {
		Tip.warn("<spring:message code="Tip.SelectAtLeastOne" />");
...
var exportMyfdUrl = path + "planner/deliveryPlan/exportMyfd";
//导出明阳风电
function exportMyfd() {
    var r = EasyUI.grid.getSelections("dg");
    if (r.length == 0) {
