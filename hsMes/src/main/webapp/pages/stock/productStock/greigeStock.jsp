	...
	<div data-options="region:'center',border:false" style="overflow: false;position: relative; height: 140px; width: 925px">
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				...
				　　仓库：<input type="text" class="easyui-combobox" name="filter[warehouseCode]"like="true" data-options="valueField:'warehouseCode',textField:'warehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=pb',onSelect:filter">
				...
				成品类别代码：<input type="text" name="filter[categoryCode]" class="easyui-textbox"><br>
					产品规格：<input type="text" name="filter[model]" like="true"
						class="easyui-textbox"> 
					入库时间：<input type="text" id="start"
						name="filter[start]" class="easyui-datetimebox"> 
					至　：<input
