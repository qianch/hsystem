...
<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="productMoveInfoForm" autoSearchFunction="false">
                ...
                起始仓库：<input type="text" class="easyui-combobox" name="filter[originWarehouseCode]" data-options="valueField:'originWarehouseCode',textField:'originWarehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=cp'">
                终点仓库：<input type="text" class="easyui-combobox" name="filter[newWarehouseCode]" data-options="valueField:'warehouseCode',textField:'warehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=cp'">
    ...
    <table id="dg" singleSelect="false" title="" class="easyui-datagrid"   toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true" data-options="onLoadSuccess:onLoadSuccess">
