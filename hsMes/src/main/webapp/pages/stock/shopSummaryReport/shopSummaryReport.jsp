...
<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        <div>
            <form action="#" id="searchForm" autoSearchFunction="false">
                ...
                <input type="text" id="factoryProductName" name="filter[factoryProductName]" like="true"
                ...
                <input type="text" id="consumerName" name="filter[CONSUMERNAME]" like="true" class="easyui-textbox">
                <label class="panel-title">客户订单号:</label>
                <input type="text" id="salesOrderSubCodePrint" name="filter[salesOrderSubCodePrint]" like="true"
                ...
                <input type="text" id="batchCode" name="filter[batchCode]" like="true" class="easyui-textbox"><br/>
                <label class="panel-title">生产车间：</label>
                <input type="text" name="filter[workShop]" like="true" class="easyui-combobox"
    ...
    <table id="dg" singleSelect="true" remotesort="false" title="车间入库汇总报表（产品大类、订单号、批次号、厂内名称）"
           class="easyui-datagrid" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"
           data-options="onLoadSuccess:onLoadSuccess,showFooter:true">
        <thead frozen="true">
        <tr>
