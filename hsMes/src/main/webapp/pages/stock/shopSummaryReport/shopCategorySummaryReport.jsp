...
<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
    <div id="toolbar">
        <div>
            <form action="#" id="searchForm" autoSearchFunction="false">
                ...
                <input type="text" id="consumerProductName" name="filter[consumerProductName]" like="true"
                       class="easyui-textbox">
    ...
    <table id="dg" singleSelect="true" remotesort="false" title="车间入库汇总报表（产品大类、厂内名称汇总重量）"
