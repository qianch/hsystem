  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="position: relative; height: 140px; width: 925px">
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="stockCheckResultSearchForm" autoSearchFunction="false">
					...
					物料代码：<input type="text" id="code" name="filter[wCode]" like="true" class="easyui-textbox">
					卷代码：<input type="text" id="code" name="filter[jCode]" like="true" class="easyui-textbox">
					托代码：<input type="text" id="code" name="filter[tCode]" like="true" class="easyui-textbox">
		...
		<table id="dg" singleSelect="false" title="盘库结果表列表" class="easyui-datagrid"  url="${path}stock/stockCheckResult/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"  data-options="onDblClickRow:dbClickEdit">
			<thead>
				<tr>
