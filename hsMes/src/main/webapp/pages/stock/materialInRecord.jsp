		...
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				...
				data-options="valueField:'warehouseCode',textField:'warehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=ycl',onSelect:filter"> 
					...
					入库时间:<input type="text" id="inStart" name="filter[inStart]" 
								value="" class="easyui-datetimebox">
					至:&nbsp;<input type="text" id="inEnd" name="filter[inEnd]"
								 value="" class="easyui-datetimebox">
								 <a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-excel" onclick="exportInRecordDetail()">
						导出
					</a></br>
