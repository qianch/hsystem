...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false"
		...
		<div id="toolbar">
			<div style="border-top:1px solid #DDDDDD">
				<form action="#" id="materialStockStateSearchForm" autoSearchFunction="false">
					仓库：<!-- <input type="text" name="filter[warehouseCode]" value=""
						class="easyui-combobox"
						data-options="data: [
	                        {value:'原材料库1',text:'原材料库1'},
	                        {value:'原材料库2',text:'原材料库2'}
                    	] ,icons: [{
					iconCls:'icon-clear',
					handler: function(e){
				...
				data-options="valueField:'warehouseName',textField:'warehouseName',url:'<%=basePath%>warehouse/getWarehouseInfo?type=ycl',onSelect:filter">
					库&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：<input type="text" like="true" name="filter[warehousePosCode]"
						class="easyui-textbox"> 
					状 　    &nbsp;态：<input type="text"
						name="filter[state]" value="" class="easyui-combobox"
						data-options="data: [
	                        {value:'0',text:'待检'},
	                        {value:'1',text:'合格'},
	                        {value:'2',text:'不合格'}
				...
				冻结<input type="text" name="filter[isLocked]" class="easyui-combobox" data-options="data:[{value:'',text:'全部'},{value:'1',text:'冻结'},{value:'0',text:'正常'}],onSelect:filter">
					</br>
					 规格：&nbsp;<input type="text" name="filter[materialModel]" like="true"
						class="easyui-textbox"> 
						托盘编号：&nbsp;<input type="text" name="filter[materialCode]" like="true"
						class="easyui-textbox"> 
					入库日期：<input type="text"
						name="filter[intimea]" class="easyui-datebox">&nbsp;至：<input
						type="text" name="filter[intimeb]" class="easyui-datebox">&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table id="dg" singleSelect="false" title="" class="easyui-datagrid"
			url="${path}stock/materialStockState/list" toolbar="#toolbar"
			...
			<thead>
				<tr>
					...
					<th field="STATE" sortable="true" width="15"
						formatter="formatterState">状态</th>
					<th field="ISLOCKED" sortable="true" width="15"
						formatter="formatterIslock">冻结状态</th>
					<th field="ISPASS" sortable="true" width="15"
						formatter="formatterIspass">是否紧急放行</th>
