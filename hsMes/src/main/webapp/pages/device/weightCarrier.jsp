  ...
  <head>
   ...
   <body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
			...
			<div style="border-top:1px solid #DDDDDD">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<label class="panel-title">载具编号：</label>
					...
					<input type="text" id="workShopCode" class="easyui-combobox" name="filter[workShopCode]"
						   data-options="valueField:'v',textField:'t',url:'<%=basePath %>department/queryDepartmentByType?type=company,cut,weave',onSelect:filter" panelHeight="200" >
		...
		<table id="weight_dg" singleSelect="false" title="" class="easyui-datagrid"  url="${path}weightCarrier/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" fit="true"  data-options="onDblClickRow:dbClickEdit">
			<thead>
				<tr>
