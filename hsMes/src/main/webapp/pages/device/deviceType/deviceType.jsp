...
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center',border:false" style="position: relative;">
		...
		<table singleSelect="true" fit="true" id="dg" title="设备类别列表" style="width:auto;" class="easyui-datagrid" url="${path}deviceType/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true"  data-options="onDblClickRow:dbClickEdit">
			<thead>
				<tr>
