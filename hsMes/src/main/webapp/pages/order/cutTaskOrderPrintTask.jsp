...
<div data-options="region:'center',border:false" style="overflow: auto;position: relative; height: 140px; width: 925px">
    ...
    <table id="dg" singleSelect="false" title="西门子裁剪车间机台打印任务列表" class="easyui-datagrid"
           url="${path}cutTaskOrderPrintTask/list" toolbar="#toolbar" pagination="true" rownumbers="true"
