...
<div data-options="region:'east',border:false,title:''" style="width: 300px;overflow-x:hidden;">
    <ul id="attachment" class="easyui-datalist" textField="FILENAME" title="附件列表（双击下载）" lines="true"
        style="width:100%;" height="auto" data-options="onDblClickRow:fileDbClick">
    </ul>
    <div id="question" class="easyui-panel" title="问题描述" style="width:100%;padding:10px;"></div>
    <div id="analysis" class="easyui-panel" title="原因分析" style="width:100%;padding:10px;"></div>
    <div id="corrective" class="easyui-panel" title="整改措施" style="width:100%;padding:10px;"></div>
</div>
<div data-options="region:'center',border:false" style="overflow: false;position: relative; ">
    <div id="toolbar">
        ...
        <div style="border-top:1px solid #DDDDDD">
            <form action="#" id="complaintSearchForm" autoSearchFunction="false">
                &nbsp投 诉 代 码 ： &nbsp<input type="text" name="filter[complaintCode]" like="true"
                                               class="easyui-textbox" like="true" data-options="onChange:filter">
                &nbsp客 户 简 称 ： &nbsp<input type="text" name="filter[consumerSimpleName]" like="true"
                                               class="easyui-textbox" like="true" data-options="onChange:filter">
                供货规格： <input type="text" name="filter[productModel]" like="true" class="easyui-textbox" like="true"
                                 data-options="onChange:filter"></br>
                &nbsp客 户 来 源 ： &nbsp<input type="text" id="cfrom" name="filter[consumerFrom]"
                                               class="easyui-combobox" data-options="onSelect:filter,onChange:filter,data: [
		                       {value:'3',text:'全部'},  {value:'国内',text:'国内'}, {value:'国外',text:'国外'}]">
                &nbsp投 诉 日 期 ： &nbsp<input type="text" name="filter[complaintDate]" class="easyui-datebox"
                                               data-options="onSelect:filter">
                </br>
                计划完成日期：<input type="text" name="filter[planFinishDate]" class="easyui-datebox"
                                    data-options="onSelect:filter">
                实际完成日期：<input type="text" name="filter[realFinishDate]" class="easyui-datebox"
                                    data-options="onSelect:filter">
    ...
    <table id="dg" singleSelect="true" title="" class="easyui-datagrid" url="${path}complaint/list" toolbar="#toolbar"
           pagination="true" rownumbers="true" fitColumns="false" fit="true"
           data-options="onDblClickRow:dbClickEdit,onClickRow:clickRow,onLoadSuccess:dgLoadSuccess">
        <thead frozen="true">
        <tr>
