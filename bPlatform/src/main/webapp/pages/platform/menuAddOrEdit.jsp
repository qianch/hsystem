...
<script type="text/javascript" src="<%=basePath%>resources/easyui/locale/easyui-lang-zh_CN.js?_=<%=nocache %>"></script>
...
<script type="text/javascript" src="<%=basePath%>resources/jquery/valid/jquery.validate.js?_=<%=nocache %>"></script>
...
<script type="text/javascript" src="<%=basePath%>resources/jquery/valid/validate-methods.js?_=<%=nocache %>"></script>
<script type="text/javascript" src="<%=basePath%>resources/jquery/valid/localization/messages_zh.min.js?_=<%=nocache %>"></script>
	...
	<form id="menu" method="post" action="<%=basePath %>/menu/${action eq 'add'?'add':'edit'}" autocomplete="off">
		...
		<table width="100%">
			...
			<tr style="display:${(menu.levelCount eq 0||menu.levelCount eq 1||menu.levelCount eq 2)?'none':''}">
				...
				<td>
					<select id="isButton" name="isButton" class="easyui-combobox" data-options="panelHeight:'auto',editable:false,panelWidth:200,onSelect:doSelect" style="width:176px;">
