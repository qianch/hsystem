...
<div>
	<form id="user" method="post" ajax="true" action="<%=basePath %>user/${action eq 'add'?'add':'edit'}" autocomplete="off" data-options="ajax:true">
		...
		<table width="100%">
			<tr>
				...
				<td><input type="text" id="userName" required="true" name="userName" value="${user.userName}" required="true" class="easyui-textbox"></td>
			</tr>
			<tr>
				<td class="title"><span style="color:red;">*</span>登录帐号:</td>
				<td><input type="text" id="loginName" required="true" validType="code"  name="loginName" value="${user.loginName}" required="true" class="easyui-textbox"></td>
			</tr>
			<tr>
				<td class="title"><span style="color:red;">*</span>编号:</td>
				<td><input type="text" id="userCode" required="true" validType="code"  name="userCode" value="${user.userCode}" required="true" class="easyui-textbox"></td>
			</tr>
			<!-- <tr>
			...
			<tr>
				...
				<td><input type="text" id="email" name="email" value="${user.email}" validType="email" class="easyui-textbox"></td>
			</tr>
			<tr>
				<td class="title"><span style="color:red;">*</span>部门:</td><!-- value="" -->
				<td>
					<input type="text" panelHeight="200px" name="did" id="departmentSelect" required="true" required="true"  value="${action eq 'add'?dept.id:user.did}" class="easyui-tree">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
						<select name="status" class="easyui-combobox" editable="false" style="width:175px" panelHeight="auto">
