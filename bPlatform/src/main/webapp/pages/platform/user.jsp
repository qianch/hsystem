...
<body  class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" >
	 ...
	 <table id="dg" fit="true" title="人员信息列表" class="easyui-datagrid"  url="<%=basePath %>user/list" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="false">
        <thead>
            <tr>
