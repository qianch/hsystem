  ...
  <body>
		...
		<div id="deptToolbar">
			<div>
				...
				<a href="javascript:void(0)" class="easyui-linkbutton l-btn l-btn-small" iconcls="icon-search" onclick="deptFilter()">
						搜索
				</a>
			</div>
		</div>
		<table id="deptGrid" toolbar="#deptToolbar" idField="id" class="easyui-datagrid" url="<%=basePath%>department/list"  pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" data-options="onLoadSuccess:onLoadSuccess">
			<thead>
				<tr>
