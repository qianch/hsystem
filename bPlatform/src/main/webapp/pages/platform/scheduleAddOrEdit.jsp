...
<div>
	<form id="schedule" method="post" action="<%=basePath %>schedule/${action eq 'add'?'add':'edit'}" autocomplete="off">
		<input type="hidden" name="id" value="${schedule.id}" /> <input type="hidden" name="createTime" value="${schedule.createTime }">
		<table width="100%">
			<tr>
				<td class="title"><span style="color:red;">*</span>任务类名</td>
				<td><input id="clazz" name="clazz" value="${schedule.clazz}" ><input type="button" onclick="getTaskName()" value="检查"></td>
			...
			<tr>
				...
				<td><input id="startTime" name="startTime" value="${schedule.startTime}" class="laydate-icon" readonly="readonly"></td>
			...
			<tr style="height:80px;">
				...
				<td colspan="3"><textarea id="runDesc" name="runDesc" style="width:100%;height:100%" style="resize: none;">${schedule.runDesc}</textarea></td>
			</tr>
		</table>
	</form>
</div>
